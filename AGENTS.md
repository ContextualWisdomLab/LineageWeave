...
Period leftover pairs (ADR 0048 / 0049 / 0119 / 0162 / 0163 / 0164 / 0182)
are computed in `lineageweave/leftover_pairs.py` from the residual after
a real GRM/GPCM score, never invented. Distances are Euclidean on the
