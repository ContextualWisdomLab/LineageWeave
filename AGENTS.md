...
Period leftover pairs (ADR 0048 / 0049 / 0183) are computed in
...
to leftover-map distance `d` so a click opens that post. Centered
leftover `U_c` and two-axis reconstruction `R̂_c` are not persisted.
