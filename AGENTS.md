...
Period leftover pairs (ADR 0017 / 0018 / 0180) are computed in
...
leftover-map cosine next to leftover-map distance `d` so a click
opens that post. Omit cosine when the complete-case map is missing
or a vector sits at the origin.
