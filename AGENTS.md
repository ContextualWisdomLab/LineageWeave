...
Period leftover pairs (ADR 0017 / 0018 / 0031) are computed in
...
a click opens that post. A home post row that is a leftover pair
also names the leftover criterion next to visibility.
