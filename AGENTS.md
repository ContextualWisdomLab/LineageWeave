...
Period leftover pairs (ADR 0048 / 0049 / 0184) are computed in
...
to leftover-map distance `d` so a click opens that post. Two-axis
reconstruction `R̂_c` is not persisted.
