...
Period leftover pairs (ADR 0048 / 0049 / 0119 / 0162 / 0163 / 0164 / 0186) are computed in
...
two-axis leftover-map reconstruction `R̂` of centered leftover.
They sit above the member list so a click opens that post.
