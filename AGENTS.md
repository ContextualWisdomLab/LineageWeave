...
Period leftover pairs (ADR 0017 / 0018 / 0030) are computed in
...
a click opens that post. A calendar commitment that is a leftover
pair also names the leftover criterion next to the due date.
