...
- The existing post-detail Buyer surface now embeds an evidence-bound project
  lifecycle timeline. Authorized order, specification-change, delivery, VOC,
  and rebid events share one temporal rail with explicit relation evidence,
  responsibility intervals, and visible-evidence handover gaps. Hidden or
  draft evidence removes dependent events, relations, assignments, and gap
  dates; associative links are never presented as causal findings (ADR 0100).
