...
values
    ...
    ('Resolve', '조직 식별', 'Resolve', '組織を特定', '识别组织', 'Xác minh tổ chức', 'Identificar organización', 'Organisation identifizieren', 'Identifier l’organisation'),
    ('Resolving...', '조직 식별 중...', 'Resolving...', '組織を特定中...', '正在识别组织...', 'Đang xác minh tổ chức...', 'Identificando organización...', 'Organisation wird identifiziert...', 'Identification de l’organisation en cours...'),
