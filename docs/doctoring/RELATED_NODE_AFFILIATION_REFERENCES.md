...
APA 7th citations for ADR-0014 (compact related-node captions). These
are the sources to open before changing affiliation display.
...
every stored row. Do not add those columns until Milestone 2.1 and
the #74 ontology stack settle `0012+` migration numbers.
