...
| Optional LLM absence is honest | Return `not_requested`, `unavailable`, or `not_invoked`; do not fabricate a score | execution adapter | LLM policy, no-pair, and schema-vocabulary tests |
