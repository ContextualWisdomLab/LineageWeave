...
Every request carries an opaque `authorization_scope_ref` issued and validated by the caller. LineageWeave includes it in canonical request identity but does not dereference it or infer authorization from it.
