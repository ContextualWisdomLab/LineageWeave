...
A fresh current-tree isolated-PostgreSQL snapshot completed all 347 tests with no
skip and 100% line-and-branch coverage for `lineageweave.py`,
`lineageweave_embeddings.py`, `lineageweave_server.py`, `compose/http_standin.py`,
and `compose/keyverse_oidc.py` (7,544 statements and 2,942 branches); no
