...
were `#658 be1d681f`, `#657 f4f7f185`, `#644 c1018a0a`, `#643 041ec13b`, `#640 31d05313`,
...
| ---: | --- | --- |
| #658 | `be1d681f` | optional Global Ask knowledge cutoff; empty-cutoff answers no longer overclaim full grounding and live answers expose `live_only`, with 22 focused tests passed; hosted checks and independent review remain required |
