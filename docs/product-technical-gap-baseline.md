...
were `#663 b39cf5f9`, `#662 92534118`, `#661 11206c58`, `#660 7d0d3ef7`, `#659 e948bd27`, `#658 b681bd53`, `#657 64f48679`, `#644 d9ff9980`, `#643 0a1f8ec1`, `#640 2d50fa01`,
`#639 aee02dca`, `#636 f7b9a65f`, `#632 cf7df7bf`, `#631 c0022c97`,
...
| #663 | `b39cf5f9` | evidence-backed Post → Project ontology neighborhood with canonical project keys, proposed truth status, project diamond/text labels, cutoff/snapshot-bounded project evidence, ADR 0222, backend ontology suite 102 passed on the current merge head; focused frontend tests 19 passed, lint, Storybook build, and runtime evidence remain recorded; hosted checks and independent review remain required |
...
| #632 | `cf7df7bf` | Global Ask provenance, public verification, knowledge cutoff, evidence-constrained query rewriting, shared ABAC/rewrite-failure review repair, #654 ontology-label readability, Semgrep static-SQL repair, and #655 authenticated durable MCP stack with live Streamable HTTP lifecycle and k6 evidence; this baseline refresh also records the current #663 head; checks and independent review remain required |
