...
#983 is exact `816423c46a4b27c42d1369d4d72c02d99eda5df6` and still owns frontend post-body parsing. The production parser repair itself remains at `63a72ef89f5a97aef1e0139430ee659efd8d9478`: deterministic quote-aware parsing covers tag recomposition, nested and outer quoted-`>` cases, embedded-image boundaries, and structural break/block/OOXML-indent handling. Predecessor exact head `c3bb8a765fc34cc1f4c6facee1bb926c19bd53f2` completed hosted Tests `35082024018` with the full PostgreSQL suite GREEN and frontend lint/build/Storybook GREEN; only the unchanged repository-wide 100% coverage gate failed. Preserved artifact `frontend-coverage` id `10449646541`, digest `sha256:8b6e9a23629358930c24cd62191b6d10216d83a4d6cf5f38470c41d6513e4481`, measured lines 3300/3405 (96.91%), statements 3548/3729 (95.14%), functions 1008/1055 (95.54%), and branches 2743/3171 (86.50%). Test-only commit `816423c46a4b27c42d1369d4d72c02d99eda5df6` covers the artifact's remaining `i18n.ts` non-DOM `document` branch without changing runtime behavior or the denominator. Current descendants are #984 `35f43f988dcb17de7419d13cd187108722a0d700`, #992 `173286078357a2404153f782b74ef8551a1fea83`, and sibling #985 `7ff4995ccb6bd72aa10da3307b58bf1228486124`, all ordinary/non-force and `behind_by=0` against their direct parent. Fresh exact-head Tests `35111478515`, SAST `35111478393`, Security `35111478519`, and CodeQL PR `35111478500` are queued; predecessor receipts do not transfer and the wider repository coverage gap remains open.
...
| Post-body parser hardening | #983 `816423c4...` | Quote-aware source repair remains at `63a72ef8...`; predecessor hosted full suite GREEN and frontend failed only the unchanged 100% coverage gate. Artifact `10449646541` measures 96.91% lines / 95.14% statements / 95.54% functions / 86.50% branches. Current head adds the artifact-driven non-DOM i18n coverage slice. Descendants #984 `35f43f98...`, #992 `17328607...`, #985 `7ff4995c...` are converged. | Fresh current-head 100% frontend/full/rendered/security/CodeQL GREEN and qualifying approval; continue artifact-driven closure without denominator/gate weakening. |
