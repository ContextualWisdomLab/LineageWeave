...
| #663 | `f8c78957` | evidence-backed Post → Project ontology neighborhood, process-unit-complete Post-focus ABAC, lookup-label enforcement under optimized Python, and #666's removal of sampled VISION-region coverage inference; its local successor incorporates #632 `d3209c5b`; hosted checks and independent review remain required |
