...
#974 exact `4341080f6027d869acb08896e41d761c3f3b8e77` owns the repository-baseline Python TLS/ReDoS repairs; child #979 exact `2dfd21110813f474d3068796d0733d96f28d6061` is ordinarily/non-force converged on that parent. Fresh required workflows remain non-accepting.
...
| Python CodeQL baseline | #974 `4341080f...` → #979 `2dfd2111...` | Source repair + behavioral TLS regression contract present; required workflows non-accepting. | Exact-head Tests/SAST/Security GREEN and producer/consumer CodeQL proof, then approval/integration. |
