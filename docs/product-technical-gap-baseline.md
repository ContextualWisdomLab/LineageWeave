...
> below the 100% threshold while the `PostBody.singleColumnTable` GFM
> regression now passes; remaining gates pending at observation, central
> fail-closed causes as above); #979 Ask
