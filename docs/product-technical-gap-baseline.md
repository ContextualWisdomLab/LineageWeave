...
| Ontology, semantic layer, provenance, W3C PROV-O projection | normalized schema, SKOS operational vocabulary concepts, `ontology_annotations` label fallback, ADR 0126, provenance modules, ADRs, evidence UI | source + unit; corpus verification open |
