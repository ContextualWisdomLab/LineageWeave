...
were `#666 f0727f84`, `#663 89716977`, `#660 24fda085`, `#659 0739b9d7`,
`#658 fe830b0a`, `#657 64f48679`, `#644 d9ff9980`, `#643 0a1f8ec1`,
`#640 2d50fa01`, `#639 aee02dca`, `#632 d3209c5b`, `#631 4cf0f088`, and
...
| #666 | `f0727f84` | removes the sampled VISION-region coverage heuristic and retains the parent image only when it carries independent evidence beyond proper subregions; stacked on #663, so protected-main delivery depends on the parent stack |
| #663 | `89716977` | evidence-backed Post → Project ontology neighborhood with canonical project keys, proposed truth status, project diamond/text labels, cutoff/snapshot-bounded project evidence, process-unit-complete Post-focus ABAC, migration replay hardening, canonical `mentions project` labeling, live ontology-publication evidence, readable lookup-label enforcement under optimized Python, and the complete #632 semantic/provenance stack before this merge; its local successor incorporates #632 `d3209c5b`; hosted checks and independent review remain required |
