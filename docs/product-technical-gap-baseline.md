...
| Calendar / Naruon | #355 delivered the projection contract; v2.17.0 wires operator consumption without forwarding the end-user token. Historical issue #336 is closed; producer/provider acceptance remains a runtime gap | Verify observed events against the published schema without invented events; keep commitments available when the channel is unwired |
...
7. **Naruon** — calendar and email/project lineage projection (historical contract #355; open issue #338).
...
3. After the queue drains, resume user-visible gaps from §5 in leverage order:
   Event Lineage evidence (historical implementation references), Naruon calendar (#355), and
...
- Calendar / Naruon: open issue #338, historical contract #355, operator consumption v2.17.0
- Ask Agent: open issues #269–#272
