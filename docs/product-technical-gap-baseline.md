...
into #640. PR #705 merged its replay guard into the non-default historical
`fix/ask-auto-source-composer` branch as `db181493`; it is stack-integration
evidence only and does not by itself deliver the optimization on #640 or main.
The
