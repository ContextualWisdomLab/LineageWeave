...
#983 exact `63a72ef89f5a97aef1e0139430ee659efd8d9478` owns frontend post-body parsing. Deterministic quote-aware parsing now covers tag recomposition, nested and outer quoted-`>` cases, embedded-image boundaries, and structural break/block/OOXML-indent handling. Current descendants remain #984 `84c644bd3876ca642358698bbb2ec89d51330510`, #992 `0a3e166fffdcb1626089f79f66f0256fb778fc8b`, and sibling #985 `d7ffc10c...`. Fresh Tests/SAST/Security/CodeQL remain nonterminal; predecessor receipts do not transfer.
...
| Post-body parser hardening | #983 `63a72ef8...` | Deterministic quote-aware parser repairs present; descendants converged. | Fresh parser/full/rendered/security/CodeQL GREEN and qualifying approval. |
