...
were `#664 b2e48d5b`, `#663 4af439d9`, `#662 92534118`, `#661 11206c58`, `#660 24fda085`, `#659 e948bd27`, `#658 fe830b0a`, `#657 64f48679`, `#644 d9ff9980`, `#643 0a1f8ec1`, `#640 2d50fa01`,
...
| #664 | `b2e48d5b` | explicit semantic content-unit kinds for paragraph, list, table, formula, and caller-parsed conversation turns; ADR 0223, idempotent migration 0221, source-boundary persistence, and 90-test focused verification; branch retargeted onto PR #660's backend-contract branch, with mergeability currently unknown; hosted checks and independent approval remain required |
| #663 | `4af439d9` | evidence-backed Post → Project ontology neighborhood with canonical project keys, proposed truth status, project diamond/text labels, cutoff/snapshot-bounded project evidence, migration replay hardening, static-SQL scanner repair, and ontology/project/migration focused suite 71 passed; stacked pnpm build-policy and semantic-unit changes retained; hosted checks and independent review remain required |
