...
| Governed translation delivery | #929 `64fa200e...` -> #932 `81332208...` | 37×8 Customer Master PostgreSQL review draft and rollback are present; no non-English English-source fallback is admitted by the contract; expected rollback-refusal transaction handling is repaired. Parent/child Tests are Draft-skipped; parent SAST/Security/CodeQL are queued. | Independent language/product review, hosted PostgreSQL GREEN, explicit immutable publication, authenticated API/browser eight-locale evidence, state/responsive/keyboard/focus/screen-reader/CJK checks, Security/SAST/CodeQL and qualifying approval. |
