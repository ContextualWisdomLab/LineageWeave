...
| ---: | --- | --- |
| #667 | `f4319480` | baseline refresh branch exact head at this snapshot; BLOCKED with review required |
...
| #669 | `2617520c` | cancelled-analysis next-action guidance, responsive audit evidence, and layout repair; UNSTABLE with hosted checks pending |
...
| #640 | `65bb0ac6` | operations-dashboard evidence touch-target, scoped metrics, and changelog repair; BLOCKED with review required |
