...
At this snapshot there were 17 open PRs and 10 open issues. Exact observed heads
were `#664 9f56079a`, `#663 be361f10`, `#662 92534118`, `#661 11206c58`, `#660 be3e28cc`, `#659 e948bd27`, `#658 fe830b0a`, `#657 64f48679`, `#644 d9ff9980`, `#643 0a1f8ec1`, `#640 2d50fa01`,
`#639 aee02dca`, `#636 f7b9a65f`, `#632 026086fb`, `#631 c0022c97`,
...
| ---: | --- | --- |
| #660 | `be3e28cc` | backend runtime/integration contract restoration with FastAPI status API, `tepp_api_key` settings wiring, existing httpx2 test extra, and the semantic-unit stack from #664; the synthetic API snapshot-digest collision is repaired; config/API contract suite passed 138 tests with 5 skips; hosted checks and independent review remain required |
...
| #664 | `9f56079a` | explicit semantic content-unit kinds for paragraph, list, table, formula, and caller-parsed conversation turns; ADR 0223, idempotent migration 0221, source-boundary persistence, and focused chunking/persistence/migration/docstring/documentation suite passed 90 tests; hosted checks and independent review remain required |
| #663 | `be361f10` | evidence-backed Post → Project ontology neighborhood with canonical project keys, proposed truth status, project diamond/text labels, cutoff/snapshot-bounded project evidence, ADR 0222, migration replay hardening for 0165/0203, and ontology/migration focused suite 82 passed; authenticated non-exact-image 4-VU concurrency evidence remains explicitly non-SLO; stacked PR #665 adds pnpm build-policy enforcement; hosted checks and independent review remain required |
...
| #632 | `026086fb` | Global Ask provenance, public verification, knowledge cutoff, evidence-constrained query rewriting, shared ABAC/rewrite-failure review repair, #654 ontology-label readability, Semgrep static-SQL repair, and #655 authenticated durable MCP stack with live Streamable HTTP lifecycle and k6 evidence; this baseline refresh also records the current #663 and #658 heads; checks and independent review remain required |
...
| --- | --- | --- |
| Protected release | 17 open PRs at snapshot: #579, #629, #631, #632, #636, #639, #640, #643, #644, #657, #658, #659, #660, #661, #662, #663, and #664. All retain hosted and/or independent-review gates; no stack merge is protected-main evidence | Terminal exact-head checks, no unresolved threads, independent exact-head approvals, protected squash-merge SHA |
...
2. Process the current LineageWeave queue #579, #629, #631, #632, #636, #639,
   #640, #643, #644, #657, #658, #659, #660, #661, #662, #663, and #664 against
