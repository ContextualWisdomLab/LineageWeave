...
No pull-request workflow run had materialized for the new RED/fix commits at the fresh receipt read, so the thumbprint change is source/executable-contract repair rather than repository-wide GREEN. #1117 was immediately ordinary/non-force reconstructed from the exact new #1120 tree plus its existing README blob and advanced to `9033347b244b48727f36d42c9bed5dcfd9684f78`; fresh parent→child compare has merge-base exactly `d2634858...`, `behind_by=0`, and README-only effective delta. No predecessor child workflow receipt transfers.
