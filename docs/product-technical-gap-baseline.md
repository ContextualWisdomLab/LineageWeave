...
were `#664 9f56079a`, `#663 110d3d29`, `#662 92534118`, `#661 11206c58`, `#660 7d0d3ef7`, `#659 e948bd27`, `#658 fe830b0a`, `#657 64f48679`, `#644 d9ff9980`, `#643 0a1f8ec1`, `#640 2d50fa01`,
...
| #663 | `110d3d29` | evidence-backed Post → Project ontology neighborhood with canonical project keys, proposed truth status, project diamond/text labels, cutoff/snapshot-bounded project evidence, ADR 0222, backend ontology suite 102 passed; authenticated non-exact-image 4-VU concurrency evidence records 261/261 endpoint checks and 1.53 s p95 combined reader latency, explicitly not exact-head or SLO evidence; stacked PR #665 adds ADR 0223 pnpm build-policy enforcement and frontend container-policy tests; frontend lint/build pass; hosted checks and independent review remain required |
