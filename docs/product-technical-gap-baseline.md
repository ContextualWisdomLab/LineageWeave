...
were `#663 3a030ad4`, `#660 24fda085`, `#659 0739b9d7`, `#658 fe830b0a`, `#657 64f48679`, `#644 d9ff9980`, `#643 0a1f8ec1`, `#640 2d50fa01`,
`#639 aee02dca`, `#632 b49b4e91`, `#631 c0022c97`,
...
> Audit snapshot: 2026-08-26 05:45 KST (refreshed by the autonomous merge
...
| #632 | `b49b4e91` | Global Ask provenance, public verification, knowledge cutoff, evidence-constrained query rewriting, shared ABAC/rewrite-failure review repair, #654 ontology-label readability, Semgrep static-SQL repair, and #655 authenticated durable MCP stack with live Streamable HTTP lifecycle and k6 evidence; checks and independent review remain required |
...
| Lineage arithmetic ownership | ADR 0225 assigns retrieval fusion and contribution arithmetic to RankWeave and measurement/estimation to TEPP and fast-mlsirm. RankWeave issue #45 owns the Rust production core. Exact RankWeave PR #41 head `1becd617` now contains a standalone PRD plus ADR 0006 for one Rust engine, a Python adapter without fallback arithmetic, provenance-bearing policies, deterministic CPU scheduling, and an explicit fail-closed GPU backend. These documents and the current Python implementation are not a released engine | Land RankWeave #41 through its protected gate, implement and release the Rust envelope under issue #45, upgrade LineageWeave's immutable pin, add fail-closed consumer conformance, and then delete local scoring, renormalization, threshold, window, and residual-map arithmetic. Preserve candidate-level theoretical-minimum evidence separately from whole-channel unavailability; never invent or locally renormalize a policy |
...
2. Process the current LineageWeave queue #579, #629, #631, #632, #636, #639,
   #640, #643, #644, #657, #658, #659, #660, #661, #662, and #663 against
