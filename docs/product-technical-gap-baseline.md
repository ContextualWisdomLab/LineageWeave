...
were `#660 a4f4c87a`, `#659 0d3a345b`, `#658 09d5bd05`, `#657 64f48679`, `#644 9ccdbcb0`, `#643 dc47a19f`, `#640 4bed57a7`,
...
| #658 | `09d5bd05` | optional Global Ask knowledge cutoff; empty-cutoff answers no longer overclaim grounding, live answers expose `live_only`, local cutoff input is converted to UTC, guidance localized, and cutoff clocks normalized; backend 22-test and frontend 96-test suites passed; hosted checks and independent review remain required |
...
| #644 | `9ccdbcb0` | frontend conditional workspace splitting with reserved surface-splitting ADR identity; checks and independent review remain required |
...
| --- | --- | --- |
| Protected release | 13 open PRs at snapshot: #579, #629, #631, #632, #636, #639, #640, #643, #644, #657, #658, #659, and #660. All retain hosted and/or independent-review gates; no stack merge is protected-main evidence | Terminal exact-head checks, no unresolved threads, independent exact-head approvals, protected squash-merge SHA |
