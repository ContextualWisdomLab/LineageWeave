...
| #490 | Wire remaining ADR 0133–0138 surfaces; exact head `494ccf53da6e4a12d54e171bbb6dfeea9b336ffc` is still open against protected `main` | Consolidated product stack; #505/#509 merges here are not protected delivery, and one hosted check currently fails |
...
| Planned-facility intent | #505 and its #509 follow-up are merged only into open #490's non-default branch; #509 merged as `e4d692c6e5daede2af7c0e259d3fc5a4c1c7636a` after 4 checks passed and 1/1 thread resolved, but with zero approvals; current #490 is `494ccf53da6e4a12d54e171bbb6dfeea9b336ffc` with one failing hosted check | Repair #490's exact-head gate and obtain independent review, then deliver the stack through protected `main` before making a release claim |
