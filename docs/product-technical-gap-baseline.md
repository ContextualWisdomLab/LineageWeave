...
#983 is exact `e5104121ab1f628cd717cf3474b45ca5c8d5a322` and owns frontend post-body parsing. The quote-aware scanner repair remains rooted at `63a72ef89f5a97aef1e0139430ee659efd8d9478`; hosted predecessor Tests `35082024018` proved that repair was incomplete because the full PostgreSQL suite, frontend lint/build and Storybook were GREEN while Vitest had one quoted-attribute `<br>` functional failure and the unchanged 100% coverage gate also failed. Causal product repair `4800c8180f44bb53feeff82c5d4d116e4c49ea3c` maps structurally parsed `<br>` to `\n\n`, preserving the existing two-segment break contract without changing scanner, list/indent, image allowlist, remote-image, auth, or runtime policy. Preserved coverage artifact `frontend-coverage` id `10449646541`, digest `sha256:8b6e9a23629358930c24cd62191b6d10216d83a4d6cf5f38470c41d6513e4481`, measured lines 3300/3405 (96.91%), statements 3548/3729 (95.14%), functions 1008/1055 (95.54%), and branches 2743/3171 (86.50%). Its LCOV still exposed uncovered `postBodyDisplay.ts` scanner/script branches; test-only commit `e5104121ab1f628cd717cf3474b45ca5c8d5a322` now covers invalid comparison-like `<` inside script content, nested same-kind script depth, unterminated script preservation, and fail-closed unquoted embedded-image `src` handling without changing production code or coverage policy. Earlier test-only `816423c46a4b27c42d1369d4d72c02d99eda5df6` covers the artifact-selected `i18n.ts` non-DOM `document` branch. Current descendants are #984 `5af25b1a5a29e4a260b7ad661254e822ece67482`, #992 `fa362ad6346e16492ec49a28f6e4685c8c652bdb`, and sibling #985 `a459470b3844380380062afe6d4c9576b3d6aeb2`, all ordinary/non-force and `behind_by=0` against their direct parent. Fresh exact-head Tests `35118382938`, SAST `35118382909`, Security `35118383064`, and CodeQL PR `35118383180` are queued; the live boundary review thread remains unresolved and predecessor receipts do not transfer.
...
| Post-body parser hardening | #983 `e5104121...` | Quoted-attribute `<br>` causal source repair remains at `4800c818...`; predecessor artifact `10449646541` measured 96.91% lines / 95.14% statements / 95.54% functions / 86.50% branches. Artifact-selected scanner/script edge coverage is now added test-only at `e5104121...`; descendants #984 `5af25b1a...`, #992 `fa362ad6...`, #985 `a459470b...` are converged `behind_by=0`. Current required workflows are queued and the live review thread remains unresolved. | Fresh exact-head functional regression/full suite, new coverage artifact and continued closure to 100%, rendered/security/CodeQL GREEN and qualifying approval; no denominator/gate weakening. |
