...
| `Chrome/Screen translation gate` | Wait for the selected-language screen or retry after an administrator publishes its complete copy. The gated destination never flashes bundled screen copy. | `StatusNotice`, `ScreenTranslationGate` |
