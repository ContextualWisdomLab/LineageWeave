...
The implementation was rechecked against the current source tree: 352 Python
tests passed with no skip, the five measured runtime modules covered 7,598
...
line-and-branch coverage run (355 tests, 7,627 statements, and 2,984 branches;
100% with no skip).
