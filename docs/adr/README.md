...
| [`product-technical-gap-baseline-history-2026-09-04.md`](../product-technical-gap-baseline-history-2026-09-04.md), [`raw archive`](../product-technical-gap-baseline-history-2026-09-04.raw.txt) | Historical product/technical traceability evidence across the ADR set; the current baseline and ADRs remain authoritative |
