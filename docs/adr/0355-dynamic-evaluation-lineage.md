...
6. **Re-walk the complete supersession prefix from every item.** Rejected because
...
consistency, duplicate and resource limits, public exports, direct-construction
seals, in-run supersession cycles, and long acyclic supersession chains. Reference
hygiene includes zero-width and bidirectional Unicode format controls.
...
separate measured performance evidence. The new projection module must retain
