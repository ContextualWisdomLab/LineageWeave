...
7. **Leftover-pair slice** (shipped in 0.71.2; ADR 0017 / 0018 / 0180): after
   IRT main effects, persist closest and farthest post–criterion pairs
   from the residual leftover map, including leftover-map cosine when
   Gabriel coordinates have non-zero norms. Do not fork LSIRM; do not invent a
