# 2.16.0 — Public ontology namespace completeness

## Added

- The repository-case public ontology namespace
  `https://contextualwisdomlab.github.io/LineageWeave/ontology#` is
  canonical ([ADR 0205], superseding ADR 0157, resolving #372): it is the
...
[ADR 0205]: docs/adr/0205-repository-case-ontology-namespace-canonical.md
