...
- Bind each request to a caller-owned opaque authorization scope and preserve
  graceful legacy reconstruction when a provider returns malformed confidence
  text.
