## 2.115.0 — Leftover-map origin on leftover-map leftover-axis independently of leftover-map comparison leftover-axis leftover-map origin

- Caption leftover-map leftover-axis leftover-map origin through leftoverMapAxisOriginBadge
  independently of leftover-map comparison leftover-axis leftover-map origin, leftover-map comparison graphic leftover-map origin, leftover-map graphic leftover-map origin, leftover-map comparison leftover-pair leftover-map criterion leftover-map origin leftover-map item coordinates, leftover-map axis origin ticks, leftover-map axis share, and leftover-map singular values (ADR 0358). After `make seed`, leftover-map leftover-axis leftover-map
