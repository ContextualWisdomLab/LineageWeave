...
- Rejected provider credentials/endpoints, scores, embedded adjudication decisions, mixed-blueprint item sets, duplicate identities, unsupported linking claims, Unicode format controls, and Unicode line/paragraph separators in opaque provenance references at the LineageWeave Anti-Corruption Layer.
