...
```bash
make up
KEYCLOAK_CLIENT_SECRET=lineageweave_test_automation_dev_only make seed
            # deterministic human-subject seed -> machine DB authorization
            # -> machine Client Credentials warm-up
