"""Immutable consumer fixture shared with the Naruon provider."""
...
from lineageweave.naruon_calendar_projection import parse_naruon_calendar_page
...
def test_calendar_projection_fixture_is_immutable_and_consumer_valid() -> None:
    fixture_path = (
    ...
    page = parse_naruon_calendar_page(json.loads(fixture_bytes))
