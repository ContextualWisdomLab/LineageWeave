...
def test_import_rows_persists_raw_and_derived_grouping_values(
    ...
    async def no_edges(_conn) -> SimpleNamespace:
        return SimpleNamespace(edges=[], coverage={})
    ...
    monkeypatch.delenv("TEPP_TEMPORAL_CONTEXT_URL", raising=False)
