...
const ENGLISH_ANALYSIS_RUN_COPY = {
  ...
  corpusPendingMeasurement: "LineageWeave will measure these posts when this run finishes.",
  ...
  corpusPendingTopicLineage:
    "LineageWeave will organize these posts into topic lineage when this run finishes.",
...
> = {
  ...
  ko: {
    ...
    corpusPendingMeasurement: "이 실행이 끝나면 LineageWeave가 이 글들을 측정합니다.",
    ...
    corpusPendingTopicLineage: "이 실행이 끝나면 LineageWeave가 이 글들을 토픽 계보로 구성합니다.",
  ...
  zh: {
    ...
    corpusPendingMeasurement: "此运行完成后，LineageWeave 将测量这些文章。",
    ...
    corpusPendingTopicLineage: "此运行完成后，LineageWeave 将把这些文章整理为主题谱系。",
  ...
  ja: {
    ...
    corpusPendingMeasurement: "この実行が完了すると、LineageWeave がこれらの投稿を測定します。",
    ...
    corpusPendingTopicLineage: "この実行が完了すると、LineageWeave がこれらの投稿をトピック系譜にまとめます。",
  ...
  vi: {
    ...
    corpusPendingMeasurement: "LineageWeave sẽ đo các bài viết này khi lượt chạy hoàn tất.",
    ...
    corpusPendingTopicLineage: "LineageWeave sẽ sắp xếp các bài viết này thành phả hệ chủ đề khi lượt chạy hoàn tất.",
