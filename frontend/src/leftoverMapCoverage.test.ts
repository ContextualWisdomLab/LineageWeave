...
describe("leftoverMapIncompleteItemCount", () => {
  ...
  it("keeps the grouping comparison graphic incomplete item label distinct from the pair-list, graphic, strip, and comparison graphic incomplete post labels", () => {
    expect(LEFTOVER_MAP_COMPARE_PLOT_INCOMPLETE_ITEM_LABEL).toBe(
      "Leftover map comparison graphic incomplete items",
    );
    expect(LEFTOVER_MAP_COMPARE_PLOT_INCOMPLETE_ITEM_LABEL).not.toBe(LEFTOVER_MAP_LIST_INCOMPLETE_ITEM_LABEL);
    expect(LEFTOVER_MAP_COMPARE_PLOT_INCOMPLETE_ITEM_LABEL).not.toBe(LEFTOVER_MAP_PLOT_INCOMPLETE_ITEM_LABEL);
    expect(LEFTOVER_MAP_COMPARE_PLOT_INCOMPLETE_ITEM_LABEL).not.toBe(LEFTOVER_MAP_COMPARE_INCOMPLETE_ITEM_LABEL);
    expect(LEFTOVER_MAP_COMPARE_PLOT_INCOMPLETE_ITEM_LABEL).not.toBe(
      LEFTOVER_MAP_COMPARE_PLOT_INCOMPLETE_POST_LABEL,
    );
  });
});
