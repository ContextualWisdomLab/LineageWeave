 ...
 *  (ADR 0303), grouping comparison leftover-map axis share
 *  (ADR 0304), and grouping comparison leftover-map rank payload
 *  (ADR 0305) caption the pair list or the grouping comparison strip,
