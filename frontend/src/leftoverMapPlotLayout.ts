 ...
 *  ADR 0339 fail-closes leftover-map pair-list leftover-map post leftover-map
 ...
 *  graphic leftover-map criterion markers.
 *  ADR 0341 fail-closes leftover-map comparison leftover-pair leftover-map post leftover-map
 *  person coordinates ξ through leftoverMapCompareListPostBadge independently of leftover-map
 *  comparison leftover-pair leftover-map criterion leftover-map item coordinates ζ, not leftover-map
 *  pair-list leftover-map post leftover-map person coordinates.
 *  ADR 0342 fail-closes leftover-map comparison leftover-pair leftover-map criterion leftover-map
 ...
 *  ADR 0347 fail-closes leftover-map graphic leftover-map criterion leftover-map origin
 *  leftover-map item coordinates through leftoverMapPlotCriterionBadge independently of leftover-map
 *  person coordinates ξ, not leftover-map comparison graphic leftover-map criterion leftover-map
 *  item coordinates.
 ...
 *  criterion leftover-map item coordinates ζ, not leftover-map comparison graphic leftover-map post leftover-map
 *  person coordinates.
 ...
 *  person coordinates.
 *  ADR 0352 fail-closes leftover-map pair leftover-map criterion leftover-map origin leftover-map
 *  item coordinates through leftoverMapListCriterionBadge independently of leftover-map
 *  pair leftover-map post leftover-map origin leftover-map person coordinates ξ, not leftover-map comparison leftover-pair leftover-map criterion leftover-map
 *  item coordinates.
 *  ADR 0353 fail-closes leftover-map comparison leftover-pair leftover-map post leftover-map origin leftover-map
 ...
 *  ADR 0357 fail-closes leftover-map comparison leftover-axis leftover-map origin through leftoverMapCompareAxisOriginBadge independently of leftover-map
 *  comparison graphic leftover-map origin, leftover-map graphic leftover-map origin, leftover-map comparison leftover-pair leftover-map
 *  criterion leftover-map origin leftover-map item coordinates, leftover-map axis origin ticks, leftover-map axis share, and leftover-map singular values.
 *  ADR 0358 fail-closes leftover-map leftover-axis leftover-map origin through leftoverMapAxisOriginBadge independently of leftover-map
 *  comparison leftover-axis leftover-map origin, leftover-map comparison graphic leftover-map origin, leftover-map graphic leftover-map origin,
 *  leftover-map comparison leftover-pair leftover-map criterion leftover-map origin leftover-map item coordinates, leftover-map axis origin ticks,
 *  leftover-map axis share, and leftover-map singular values.
 *  ADR 0359 fail-closes leftover-map pair leftover-map origin through leftoverMapListOriginBadge independently of leftover-map
 *  leftover-axis leftover-map origin, leftover-map comparison leftover-axis leftover-map origin, leftover-map comparison graphic leftover-map origin,
 *  leftover-map graphic leftover-map origin, leftover-map pair leftover-map criterion leftover-map origin leftover-map item coordinates,
 *  leftover-map axis origin ticks, leftover-map axis share, and leftover-map singular values.
 */
...
export const LEFTOVER_MAP_PLOT_POST_ACTION_ORIGIN =
...
export const LEFTOVER_MAP_COMPARE_PLOT_POST_ACTION_ORIGIN =
...
export const LEFTOVER_MAP_PLOT_CRITERION_ORIGIN =
...
export function leftoverMapPlotPostBadge(
  ...
  return {
    key: origin ? LEFTOVER_MAP_PLOT_POST_ACTION_ORIGIN : LEFTOVER_MAP_PLOT_POST_ACTION,
    values: { title, person },
  };
}
...
export function leftoverMapComparePlotPostBadge(
  ...
  const origin = leftoverMapPlotCoordinatePairIsOrigin(person);
  return {
    key: origin ? LEFTOVER_MAP_COMPARE_PLOT_POST_ACTION_ORIGIN : LEFTOVER_MAP_COMPARE_PLOT_POST_ACTION,
    values: { title, person },
  };
}
