 ...
 * this pair list. ADR 0305 captions leftover-map axis share on that
 * grouping comparison leftover-map graphic, not this pair list. ADR 0306
 ...
 * on that grouping comparison leftover-map graphic, not this pair list. ADR 0309
 * captions leftover-map incomplete item coverage on that grouping comparison
 ...
 * ADR 0351 captions leftover-map origin on leftover-map pair leftover-map post leftover-map person coordinates through leftoverMapListPostBadge
 ...
 * not this pair list.
 * ADR 0353 captions leftover-map origin on leftover-map comparison leftover-pair leftover-map post leftover-map person coordinates through leftoverMapCompareListPostBadge,
 * not this pair list.
 ...
 * not this pair list.
 * ADR 0356 captions leftover-map comparison graphic leftover-map origin through leftoverMapComparePlotOriginBadge,
 * not this pair list.
 * ADR 0357 captions leftover-map comparison leftover-axis leftover-map origin through leftoverMapCompareAxisOriginBadge,
 * not this pair list.
