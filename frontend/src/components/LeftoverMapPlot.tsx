 ...
 * returns true. Caption leftover-map origin on leftover-map graphic leftover-map
 * post leftover-map person coordinates independently of leftover-map criterion leftover-map item coordinates when leftoverMapPlotCoordinatePairIsOrigin
 ...
 * pair leftover-map post leftover-map origin leftover-map person coordinates, not this graphic.
 ...
 * singular values.
 * ADR 0357 fail-closes leftover-map comparison leftover-axis leftover-map origin through
 * leftoverMapCompareAxisOriginBadge independently of leftover-map comparison graphic leftover-map origin,
 ...
 * coordinates, leftover-map axis origin ticks, leftover-map axis share, and leftover-map
 * singular values, not this graphic.
 * ADR 0359 fail-closes leftover-map pair leftover-map origin through
 * leftoverMapListOriginBadge independently of leftover-map leftover-axis leftover-map origin,
 * leftover-map comparison leftover-axis leftover-map origin, leftover-map comparison graphic leftover-map origin,
 * leftover-map graphic leftover-map origin, leftover-map pair leftover-map criterion leftover-map origin leftover-map item
 * coordinates, leftover-map axis origin ticks, leftover-map axis share, and leftover-map
 * singular values, not this graphic.
