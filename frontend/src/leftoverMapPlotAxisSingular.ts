 ...
 *  leftover-map singular values. leftoverMapPlotTickAxisBadge, leftoverMapCompareAxisTickBadge,
 *  and leftoverMapAxisTickBadge do not name leftover-map origin this increment.
 */
