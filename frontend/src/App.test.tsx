...
describe("App, authenticated", () => {
  ...
  it("shows the calibrated period-report mean theta on the home page", async () => {
    ...
    expect(closestPair).toHaveTextContent(
      "Leftover-map inner product ξ·ζ +0.40 reconstructs leftover residual after IRT main effects. Open this post to read sales-lead.",
    );
    expect(closestPair).toHaveTextContent("ξ·ζ +0.40");
    ...
    expect(farthestPair).toHaveTextContent(
      "Leftover-map inner product ξ·ζ −1.10 reconstructs leftover residual after IRT main effects. Open this post to read negative.",
    );
    expect(farthestPair).toHaveTextContent("ξ·ζ −1.10");
