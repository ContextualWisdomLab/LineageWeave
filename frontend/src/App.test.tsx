...
describe("App, authenticated", () => {
  ...
  it("shows the calibrated period-report mean theta on the home page", async () => {
    ...
    expect(closestPair).toHaveTextContent(
      "Leftover map reconstructs R̂ +0.40 after IRT main effects. Open this post to read sales-lead.",
    );
    ...
    expect(farthestPair).toHaveTextContent(
      "Leftover map reconstructs R̂ −1.10 after IRT main effects. Open this post to read negative.",
    );
