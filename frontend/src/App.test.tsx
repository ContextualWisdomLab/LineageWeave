...
describe("App, authenticated", () => {
  ...
  function stubBackend(options?: {
              ...
              ? [
                  {
                    ...
                    customer_identity_judgment_id: null,
                    hint_trust: "normal",
    ...
    return Object.assign(fetchMock, { releaseMe, releasePosts, releaseCustomerMasterHint, releasePostOne });
  }
  ...
  it("renders every cited lineage thread as its own git-branch-style graph", async () => {
    ...
    expect(
      screen.getByRole("button", { name: "Open post: Unrelated thread post (Root record)" }),
    ).toBeInTheDocument();
  });
