...
describe("App, authenticated", () => {
                ...
                leftover_pairs: [
                  {
                    ...
                    leftover_map_rank: 1,
                    leftover_map_unexplained_share: 0.12,
                  },
                  {
                    pair_kind: "farthest",
                    post_id: "post-2",
                    ...
                    expected_response: 2.0,
                    leftover_map_rank: 1,
                    leftover_map_unexplained_share: 0.45,
                  },
                ],
                leftover_map_axes: [
                  {
  ...
  it("shows the calibrated period-report mean theta on the home page", async () => {
    ...
    expect(closestPair).toHaveTextContent(
      "Read leftover map rank 1, observed Y 2.40, expected E 2.00, and unexplained share 0.12 after IRT main effects, then open this post.",
    );
    ...
    expect(farthestPair).toHaveTextContent(
      "Read leftover map rank 1, observed Y 0.90, expected E 2.00, and unexplained share 0.45 after IRT main effects, then open this post.",
    );
