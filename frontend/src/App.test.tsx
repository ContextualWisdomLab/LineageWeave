...
describe("App, authenticated", () => {
                ...
                leftover_pairs: [
                  {
                    ...
                    leftover_map_person_length: 0.4,
                    leftover_map_item_length: 0.5,
                  },
                  {
                    pair_kind: "farthest",
                    post_id: "post-2",
                    ...
                    leftover_map_person_length: 1.2,
                    leftover_map_item_length: 0.9,
                  },
                ],
                members: [
                  {
  ...
  it("shows the calibrated period-report mean theta on the home page", async () => {
    ...
    expect(closestPair).toHaveTextContent(
      "Leftover-map length ‖ξ‖ 0.40 and ‖ζ‖ 0.50 names leftover-map magnitude independently of leftover-map distance. Open this post to read sales-lead.",
    );
    expect(closestPair).toHaveTextContent("‖ξ‖ 0.40");
    expect(closestPair).toHaveTextContent("‖ζ‖ 0.50");
    ...
    expect(farthestPair).toHaveTextContent(
      "Leftover-map length ‖ξ‖ 1.20 and ‖ζ‖ 0.90 names leftover-map magnitude independently of leftover-map distance. Open this post to read negative.",
    );
    expect(farthestPair).toHaveTextContent("‖ξ‖ 1.20");
    expect(farthestPair).toHaveTextContent("‖ζ‖ 0.90");
