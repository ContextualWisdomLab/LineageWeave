...
describe("i18n", () => {
  ...
  const requiredSharedLabels = [
    ...
    "Additional context review was unavailable. Open both source posts and compare the listed signals before relying on this connection.",
    "Context review",
    "Recorded signal",
    "{from} follows {to}, connection score {score}",
    "Derived from post evidence",
    ...
    "Search includes post text and related evidence.",
    "Before connecting a customer, compare each source identifier with the related posts and organization evidence.",
    "Related project",
    "Related role",
    "Related key person",
    "Related record",
    "Last saved summary shown. Retry summary refresh.",
    "Temporal proximity",
    "Contains",
    "Overlaps",
    "Interval relations",
    ...
    "Some evidence was unavailable at the selected time. Open the cited posts before relying on this answer.",
    "Evidence at selected time",
    "All cited evidence was available by this time",
    "Some cited evidence was unavailable at this time",
    "Reports and evidence alerts",
