...
describe("i18n", () => {
  ...
  const relatedRecordLabels = [
    ...
    "No related records are available here. Open a record or organization next.",
    ...
    "Related information is unavailable. Open a visible record next.",
