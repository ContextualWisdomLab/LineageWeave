          ...
          <div className="login-card">
            ...
            <div className="login-controls">
              <button className="btn-primary" onClick={() => {
                const returnUrl = returnUrlFromLocation();
                // The OIDC `state` round-trip is the primary path (read by
                // onSigninCallback in main.tsx); storage is the fallback for
                // an IdP that does not preserve custom state.
                rememberOidcReturnUrl(returnUrl);
                void auth.signinRedirect({ state: { returnUrl } });
              }}>
                {t("Log in")}
