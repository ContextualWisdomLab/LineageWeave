            ...
            {report.leftover_pairs && report.leftover_pairs.length > 0 && (
              <ul className="ticket-list" aria-label={t("Leftover pairs")}>
                {report.leftover_pairs.map((pair) => {
                  ...
                  const mapCosine = formatLeftoverMapCosine(pair.leftover_map_cosine);
                  const nextAction =
                    mapCosine === null
                      ...
                      : tf(LEFTOVER_MAP_COSINE_ACTION, {
                          value: formatSignedLeftoverValue(pair.leftover_map_cosine ?? Number.NaN) ?? "—",
                          criterion,
                        });
                  return (
                    <li
                    ...
                    >
                      ...
                      >
                        ...
                        {mapCosine ? (
                          <span className="post-badge">{mapCosine}</span>
                        ) : null}
