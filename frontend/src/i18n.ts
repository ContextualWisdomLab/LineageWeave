...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    "Leftover map comparison leftover residual": "잔여 지도 비교 잔여",
  ...
  zh: {
    ...
    "Leftover map comparison leftover residual": "残差地图比较残差",
  ...
  ja: {
    ...
    "Leftover map comparison leftover residual": "残差マップの比較残差",
  ...
  vi: {
    ...
    "Leftover map comparison leftover residual": "Phần dư so sánh bản đồ phần dư",
