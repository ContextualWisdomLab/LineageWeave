...
const OPERATIONS_TRANSLATIONS: Record<"zh" | "ja" | "vi", Record<string, string>> = {
  zh: {
    "Start date": "开始日期", "End date": "结束日期", "Apply period": "应用期间", "Voice evidence overview": "声音证据概览",
  ...
  ja: {
    "Start date": "開始日", "End date": "終了日", "Apply period": "期間を適用", "Voice evidence overview": "Voice根拠の概要",
  ...
  vi: {
    "Start date": "Ngày bắt đầu", "End date": "Ngày kết thúc", "Apply period": "Áp dụng khoảng thời gian", "Voice evidence overview": "Tổng quan bằng chứng tiếng nói",
