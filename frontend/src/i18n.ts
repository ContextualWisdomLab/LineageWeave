...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ...
  ja: {
    ...
    "Edges explain reconstructed continuation only. They are not causal or authoritative facts.":
      "エッジは再構成された継続性のみを示し、因果関係や権威ある事実ではありません。",
  ...
  vi: {
    ...
    "Parent to child": "Từ bản ghi cha đến bản ghi con",
    "Inference boundary": "Ranh giới suy luận",
    "Edges explain reconstructed continuation only. They are not causal or authoritative facts.":
      "Các cạnh chỉ giải thích sự tiếp nối được tái dựng; chúng không phải quan hệ nhân quả hay sự thật có thẩm quyền.",
