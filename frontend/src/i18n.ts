...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    "Leftover map comparison axis singular": "잔여 지도 비교 축 특이값",
    "leftover map comparison axis {axis} σ {value}": "잔여 지도 비교 축 {axis} σ {value}",
  ...
  zh: {
    ...
    "Leftover map comparison axis singular": "残差地图比较轴奇异值",
    "leftover map comparison axis {axis} σ {value}": "残差地图比较轴 {axis} σ {value}",
  ...
  ja: {
    ...
    "Leftover map comparison axis singular": "残差マップの比較軸の特異値",
    "leftover map comparison axis {axis} σ {value}": "残差マップの比較軸 {axis} σ {value}",
  ...
  vi: {
    ...
    "Leftover map comparison axis singular": "Giá trị singular trục so sánh bản đồ phần dư",
    "leftover map comparison axis {axis} σ {value}": "trục so sánh bản đồ phần dư {axis} σ {value}",
