...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    "External voice overview": "외부 관계 근거 현황",
    "Loading external relationship evidence...": "외부 관계 근거를 불러오는 중입니다...",
    "External relationship evidence could not be loaded.": "외부 관계 근거를 불러오지 못했습니다.",
    "Retry external relationship evidence": "외부 관계 근거 다시 시도",
    "Compare evidence across {count} visible records.": "표시 가능한 기록 {count}건의 관계 근거를 비교합니다.",
    "Needs review": "재검토 필요",
    "One record may support several relationships, so category counts can overlap.": "한 기록이 여러 관계를 뒷받침할 수 있어 항목별 건수는 중복될 수 있습니다.",
    "Review disagreements and records without evidence before using these relationships.": "불일치와 근거 없는 기록을 확인한 뒤 이 관계를 활용하세요.",
    Public: "공개",
    Private: "비공개",
    "Newest first": "최신순",
    "Oldest first": "오래된 순",
  ...
  zh: {
    ...
    "External voice overview": "外部关系证据概览",
    "Loading external relationship evidence...": "正在加载外部关系证据...",
    "External relationship evidence could not be loaded.": "无法加载外部关系证据。",
    "Retry external relationship evidence": "重试外部关系证据",
    "Compare evidence across {count} visible records.": "比较 {count} 条可见记录中的关系证据。",
    "Needs review": "需要复核",
    "One record may support several relationships, so category counts can overlap.": "一条记录可能支持多个关系，因此各类别计数可能重叠。",
    "Review disagreements and records without evidence before using these relationships.": "使用这些关系前，请检查不一致项和缺少证据的记录。",
    Public: "公开",
    Private: "私有",
    "Newest first": "最新优先",
    "Oldest first": "最早优先",
  ...
  ja: {
    ...
    "External voice overview": "外部関係の証拠概要",
    "Loading external relationship evidence...": "外部関係の証拠を読み込んでいます...",
    "External relationship evidence could not be loaded.": "外部関係の証拠を読み込めませんでした。",
    "Retry external relationship evidence": "外部関係の証拠を再試行",
    "Compare evidence across {count} visible records.": "表示可能な記録 {count} 件の関係証拠を比較します。",
    "Needs review": "要確認",
    "One record may support several relationships, so category counts can overlap.": "1件の記録が複数の関係を裏付ける場合があるため、カテゴリ件数は重複します。",
    "Review disagreements and records without evidence before using these relationships.": "不一致と証拠のない記録を確認してから、これらの関係を利用してください。",
    Public: "公開",
    Private: "非公開",
    "Newest first": "新しい順",
    "Oldest first": "古い順",
  ...
  vi: {
    ...
    "External voice overview": "Tổng quan bằng chứng quan hệ bên ngoài",
    "Loading external relationship evidence...": "Đang tải bằng chứng quan hệ bên ngoài...",
    "External relationship evidence could not be loaded.": "Không thể tải bằng chứng quan hệ bên ngoài.",
    "Retry external relationship evidence": "Thử lại bằng chứng quan hệ bên ngoài",
    "Compare evidence across {count} visible records.": "So sánh bằng chứng quan hệ trong {count} bản ghi có thể xem.",
    "Needs review": "Cần xem lại",
    "One record may support several relationships, so category counts can overlap.": "Một bản ghi có thể hỗ trợ nhiều quan hệ nên số lượng theo nhóm có thể trùng lặp.",
    "Review disagreements and records without evidence before using these relationships.": "Hãy xem lại điểm bất đồng và bản ghi thiếu bằng chứng trước khi dùng các quan hệ này.",
    Public: "Công khai",
    Private: "Riêng tư",
