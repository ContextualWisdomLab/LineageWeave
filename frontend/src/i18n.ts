...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    "Open the cited public resource, then compare it with the highlighted post evidence.":
      "인용된 공개 자료를 연 다음 강조 표시된 게시글 근거와 비교하세요.",
    ...
    "Post excerpt": "게시글 발췌문",
    "Public evidence reviewed": "공개 근거 검토 완료",
    "Issue tickets": "이슈 티켓",
    "Key events": "주요 이벤트",
  ...
  zh: {
    ...
    "Post excerpt": "帖子摘录",
    "Public evidence reviewed": "公开证据已核查",
    "Issue tickets": "问题工单",
    "Key events": "关键事件",
  ...
  ja: {
    ...
    "Researching...": "調査中...",
    "Open the cited public resource, then compare it with the highlighted post evidence.":
      "引用した公開資料を開き、投稿内で強調された証拠と比較してください。",
    ...
    "Post excerpt": "投稿の抜粋",
    "Public evidence reviewed": "公開証拠を確認済み",
  ...
  vi: {
    ...
    "Open the cited public resource, then compare it with the highlighted post evidence.":
      "Mở tài liệu công khai được trích dẫn, rồi so sánh với bằng chứng được đánh dấu trong bài viết.",
    ...
    "Post excerpt": "Đoạn trích bài viết",
    "Public evidence reviewed": "Đã xem xét bằng chứng công khai",
