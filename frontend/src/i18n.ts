...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    "Authorized project evidence": "권한이 있는 프로젝트 근거",
    "Select an exact project identity to read its visible history.": "정확한 프로젝트 식별자를 선택하여 공개 가능한 이력을 읽으세요.",
    "Loading project history...": "프로젝트 이력을 불러오는 중...",
    "No authorized project evidence is available.": "권한이 있는 프로젝트 근거가 없습니다.",
    "Open project history": "프로젝트 이력 열기",
    "Open project history for: {name}": "{name} 프로젝트 이력 열기",
    "Ask Agent": "Ask Agent",
    ...
    "Event Lineage timeline": "이벤트 계보 타임라인",
  ...
  zh: {
    ...
    "Authorized project evidence": "已授权的项目依据",
    "Select an exact project identity to read its visible history.": "选择准确的项目身份以查看可见历史。",
    "Loading project history...": "正在加载项目历史…",
    "No authorized project evidence is available.": "没有可用的已授权项目依据。",
    "Open project history": "打开项目历史",
    "Open project history for: {name}": "打开{name}的项目历史",
    "Ask Agent": "Ask Agent",
    ...
    "This answer is fully grounded at the requested cutoff. Open a cited post to compare the retained body.":
      "此答案完全基于所请求截止时间的证据。打开一篇引用文章以比较当时保留的正文。",
    "This answer is only partly grounded at the requested cutoff. Open a cited post to see which historical bodies were retained.":
    ...
    "Event Lineage timeline": "事件谱系时间线",
    "Open timeline post:": "打开时间线文章：",
  ...
  ja: {
    ...
    "Authorized project evidence": "認証済みプロジェクト証拠",
    "Select an exact project identity to read its visible history.": "正確なプロジェクト識別子を選び、表示可能な履歴を読みます。",
    "Loading project history...": "プロジェクト履歴を読み込み中…",
    "No authorized project evidence is available.": "利用可能な認証済みプロジェクト証拠はありません。",
    "Open project history": "プロジェクト履歴を開く",
    "Open project history for: {name}": "{name}のプロジェクト履歴を開く",
    "Ask Agent": "Ask Agent",
    ...
    "This answer is fully grounded at the requested cutoff. Open a cited post to compare the retained body.":
      "この回答は指定した基準時刻の根拠で完全に裏付けられています。引用投稿を開いて当時の本文を比較してください。",
    "This answer is only partly grounded at the requested cutoff. Open a cited post to see which historical bodies were retained.":
    ...
    "Event Lineage timeline": "イベント系譜タイムライン",
    "Open timeline post:": "タイムラインの投稿を開く:",
  ...
  vi: {
    ...
    "Weekly VOC": "VOC hàng tuần",
    "Filter by ISO week": "Lọc theo tuần ISO",
    "All weeks": "Tất cả các tuần",
    "Voice of Customer posts for {week} are current. Open a post to read Event Lineage.":
    ...
    "Authorized project evidence": "Bằng chứng dự án được cấp quyền",
    "Select an exact project identity to read its visible history.": "Chọn đúng danh tính dự án để đọc lịch sử có thể xem.",
    "Loading project history...": "Đang tải lịch sử dự án…",
    "No authorized project evidence is available.": "Không có bằng chứng dự án được cấp quyền.",
    "Open project history": "Mở lịch sử dự án",
    "Open project history for: {name}": "Mở lịch sử dự án của {name}",
    "Ask Agent": "Ask Agent",
    ...
    "Knowledge cutoff (optional)": "Mốc kiến thức (tùy chọn)",
    "This answer is fully grounded at the requested cutoff. Open a cited post to compare the retained body.":
      "Câu trả lời này được căn cứ đầy đủ theo mốc thời gian đã chọn. Hãy mở bài trích dẫn để so sánh nội dung được lưu lúc đó.",
    "This answer is only partly grounded at the requested cutoff. Open a cited post to see which historical bodies were retained.":
    ...
    "Event Lineage timeline": "Dòng sự kiện theo thời gian",
    "Open timeline post:": "Mở bài viết trên dòng thời gian:",
