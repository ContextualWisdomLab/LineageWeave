...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    "W is confirmed by this app's own behavior. Other codes are an unconfirmed working hypothesis, not a verified fact.":
      "W는 이 앱 자체의 동작으로 확인됩니다. 다른 코드는 검증되지 않은 추정일 뿐, 확인된 사실이 아닙니다.",
  ...
  zh: {
    ...
    "W is confirmed by this app's own behavior. Other codes are an unconfirmed working hypothesis, not a verified fact.":
      "W 由本应用自身的行为确认。其他代码只是未经证实的推测，并非已验证的事实。",
  ...
  ja: {
    ...
    "W is confirmed by this app's own behavior. Other codes are an unconfirmed working hypothesis, not a verified fact.":
      "Wはこのアプリ自体の動作で確認されています。他のコードは未確認の推定であり、検証済みの事実ではありません。",
  ...
  vi: {
    ...
    "W is confirmed by this app's own behavior. Other codes are an unconfirmed working hypothesis, not a verified fact.":
      "W được xác nhận bởi chính hành vi của ứng dụng này. Các mã khác chỉ là giả thuyết chưa được xác minh, không phải sự thật đã được kiểm chứng.",
