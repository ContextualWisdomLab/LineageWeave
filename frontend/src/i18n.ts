...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    "Open a result to review the records most relevant to your search.": "검색과 가장 관련 있는 기록을 확인하려면 결과를 여세요.",
  ...
  zh: {
    ...
    "Open a result to review the records most relevant to your search.": "打开结果以查看与搜索最相关的记录。",
  ...
  ja: {
    ...
    "Open a result to review the records most relevant to your search.": "検索に最も関連する記録を確認するには結果を開いてください。",
  ...
  vi: {
    ...
    "Open a result to review the records most relevant to your search.": "Mở một kết quả để xem các bản ghi phù hợp nhất với tìm kiếm.",
