...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ...
  zh: {
    ...
    "Source process unit catalog hint": "来源事业部(PU)目录提示",
    "Catalog hint": "目录提示",
    "Source order pool": "来源订单池",
    "Source sales order": "来源销售订单",
    "Source sales order item": "来源销售订单项",
    "Source inspection point": "来源检验点",
    "Source context": "来源背景",
    "Source fields": "来源字段",
    "Source lineage combination": "来源谱系组合",
    "Combination code": "组合代码",
    "Field combination": "字段组合",
    Present: "有",
    "Not present": "无",
    "Inferred from field presence": "根据字段是否存在推断",
    "Lifecycle vector": "生命周期向量",
    "Raw codes only": "仅显示原始代码",
    "No sales identifier candidate": "无销售标识符候选",
    "Customer only candidate": "仅客户候选",
    "Customer + order-pool candidate": "客户 + 订单池候选",
    "Sales-order item context": "销售订单项背景",
    "Sales-order item without customer": "无客户的销售订单项",
    "Order-pool only candidate": "仅订单池候选",
    "Sales order without item candidate": "无品项的销售订单候选",
    "Customer + sales order without item": "客户 + 无品项销售订单",
    "Mixed source identifier context": "混合来源标识符背景",
    "Customer code": "客户代码",
    "Order pool": "订单池",
    "Sales order": "销售订单",
    "Sales-order item": "销售订单项",
    "Source body was not imported; summary and semantic extraction are unavailable.":
    ...
    "Account": "账户",
    "Affiliation": "所属",
    "Answers cite authorized posts when available.": "如有可能，答案会引用有权限的帖子。",
    "Authorized evidence": "有权限的证据",
    "Board advanced review": "看板高级审核",
    "Evidence workspace": "证据工作区",
    "Existing workspace surface": "现有工作区界面",
    "Explicit semantic relationships": "显式语义关系",
    "None": "无",
    "Open in Board": "在看板中打开",
    "Organization member of": "所属组织成员",
    "Organization unit of": "组织单位",
    Permissions: "权限",
    "R&R affiliation: {name}": "R&R 所属：{name}",
    "Responsible for": "负责",
    "Sub-organization of": "下级组织",
    "Summary could not be generated.": "无法生成摘要。",
    "Summary is not created for writing posts.": "正在撰写中的帖子不会生成摘要。",
    Supports: "支持",
  ...
  ja: {
    ...
    "Source process unit catalog hint": "原典の事業部(PU)カタログヒント",
    "Catalog hint": "カタログヒント",
    "Source order pool": "原典のオーダープール",
    "Source sales order": "原典の受注",
    "Source sales order item": "原典の受注品目",
    "Source inspection point": "原典の検査ポイント",
    "Source context": "原典のコンテキスト",
    "Source fields": "原典のフィールド",
    "Source lineage combination": "原典系譜の組み合わせ",
    "Combination code": "組み合わせコード",
    "Field combination": "フィールドの組み合わせ",
    Present: "あり",
    "Not present": "なし",
    "Inferred from field presence": "フィールドの有無から推定",
    "Lifecycle vector": "ライフサイクルベクトル",
    "Raw codes only": "生コードのみ表示",
    "No sales identifier candidate": "受注識別子候補なし",
    "Customer only candidate": "顧客のみの候補",
    "Customer + order-pool candidate": "顧客 + オーダープール候補",
    "Sales-order item context": "受注品目のコンテキスト",
    "Sales-order item without customer": "顧客なしの受注品目",
    "Order-pool only candidate": "オーダープールのみの候補",
    "Sales order without item candidate": "品目なしの受注候補",
    "Customer + sales order without item": "顧客 + 品目なしの受注",
    "Mixed source identifier context": "混在した原典識別子コンテキスト",
    "Customer code": "顧客コード",
    "Order pool": "オーダープール",
    "Sales order": "受注",
    "Sales-order item": "受注品目",
    "Source body was not imported; summary and semantic extraction are unavailable.":
    ...
    "Account": "アカウント",
    "Affiliation": "所属",
    "Answers cite authorized posts when available.": "可能な場合、回答は権限のある投稿を引用します。",
    "Authorized evidence": "権限のある根拠",
    "Board advanced review": "掲示板の高度なレビュー",
    "Evidence workspace": "根拠のワークスペース",
    "Existing workspace surface": "既存のワークスペース画面",
    "Explicit semantic relationships": "明示的な意味関係",
    "None": "なし",
    "Open in Board": "掲示板で開く",
    "Organization member of": "組織のメンバー",
    "Organization unit of": "組織の単位",
    Permissions: "権限",
    "R&R affiliation: {name}": "R&R 所属：{name}",
    "Responsible for": "担当",
    "Sub-organization of": "下位組織",
    "Summary could not be generated.": "概要を生成できませんでした。",
    "Summary is not created for writing posts.": "作成中の投稿には概要が作成されません。",
    Supports: "支援",
    "The existing Board owns the selected post and its provenance, so this action opens there instead of duplicating the workflow.":
  ...
  vi: {
    ...
    "Source process unit catalog hint": "Gợi ý danh mục đơn vị kinh doanh nguồn (PU)",
    "Catalog hint": "Gợi ý danh mục",
    "Source order pool": "Nhóm đơn hàng nguồn",
    "Source sales order": "Đơn bán hàng nguồn",
    "Source sales order item": "Hạng mục đơn bán hàng nguồn",
    "Source inspection point": "Điểm kiểm tra nguồn",
    "Source context": "Bối cảnh nguồn",
    "Source fields": "Trường dữ liệu nguồn",
    "Source lineage combination": "Tổ hợp dòng nguồn",
    "Combination code": "Mã tổ hợp",
    "Field combination": "Tổ hợp trường dữ liệu",
    Present: "Có",
    "Not present": "Không có",
    "Inferred from field presence": "Suy ra từ sự hiện diện của trường dữ liệu",
    "Lifecycle vector": "Vectơ vòng đời",
    "Raw codes only": "Chỉ hiển thị mã nguyên bản",
    "No sales identifier candidate": "Không có ứng viên mã định danh bán hàng",
    "Customer only candidate": "Ứng viên chỉ có khách hàng",
    "Customer + order-pool candidate": "Ứng viên khách hàng + nhóm đơn hàng",
    "Sales-order item context": "Bối cảnh hạng mục đơn bán hàng",
    "Sales-order item without customer": "Hạng mục đơn bán hàng không có khách hàng",
    "Order-pool only candidate": "Ứng viên chỉ có nhóm đơn hàng",
    "Sales order without item candidate": "Ứng viên đơn bán hàng không có hạng mục",
    "Customer + sales order without item": "Khách hàng + đơn bán hàng không có hạng mục",
    "Mixed source identifier context": "Bối cảnh mã định danh nguồn hỗn hợp",
    "Customer code": "Mã khách hàng",
    "Order pool": "Nhóm đơn hàng",
    "Sales order": "Đơn bán hàng",
    "Sales-order item": "Hạng mục đơn bán hàng",
    "Source body was not imported; summary and semantic extraction are unavailable.":
    ...
    "Legend": "Chú giải",
    "Category": "Danh mục",
    "Time order": "Thứ tự thời gian",
    "Hierarchy": "Quan hệ thứ bậc",
    "Cause and effect": "Quan hệ nhân quả",
    "Other relation": "Quan hệ khác",
    ...
    "Answers cite authorized posts when available.": "Câu trả lời trích dẫn các bài viết được cấp quyền khi có thể.",
    "Authorized evidence": "Bằng chứng được cấp quyền",
    "Board advanced review": "Xem xét nâng cao trên Bảng tin",
    "Evidence workspace": "Không gian khám phá bằng chứng",
    "Existing workspace surface": "Màn hình không gian làm việc hiện có",
    "Explicit semantic relationships": "Quan hệ ngữ nghĩa rõ ràng",
    "None": "Không có",
    "Open in Board": "Mở trong Bảng tin",
    "Organization member of": "Thành viên của tổ chức",
    "Organization unit of": "Đơn vị của tổ chức",
    Permissions: "Quyền hạn",
    "R&R affiliation: {name}": "R&R trực thuộc: {name}",
    "Responsible for": "Chịu trách nhiệm về",
    "Sub-organization of": "Tổ chức trực thuộc",
    "Summary could not be generated.": "Không thể tạo tóm tắt.",
    "Summary is not created for writing posts.": "Không tạo tóm tắt cho bài viết đang soạn thảo.",
    Supports: "Hỗ trợ",
    "The existing Board owns the selected post and its provenance, so this action opens there instead of duplicating the workflow.":
