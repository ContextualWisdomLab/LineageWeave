...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    "Open the cited public resource, then compare it with this post's source unit or image region.":
      "인용된 공개 자료를 연 다음 이 글의 출처 단위나 이미지 영역과 비교하세요.",
  ...
  ja: {
    ...
    "Researching...": "調査中...",
    "Open the cited public resource, then compare it with this post's source unit or image region.":
      "引用した公開資料を開き、この投稿の出典単位または画像領域と比較してください。",
  ...
  vi: {
    ...
    "Open the cited public resource, then compare it with this post's source unit or image region.":
      "Mở tài liệu công khai được trích dẫn, rồi so sánh với đơn vị nguồn hoặc vùng hình ảnh của bài này.",
