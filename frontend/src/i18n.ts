...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    "{start} ~ {end} · Event time": "{start} ~ {end} · Event 발생일", "{start} or later · Event time": "{start} 이후 · Event 발생일", "Through {end} · Event time": "{end} 이전 · Event 발생일", "All time · Event time": "전체 기간 · Event 발생일",
    "{days}d {hours}h {minutes}m {seconds}s": "{days}일 {hours}시간 {minutes}분 {seconds}초",
    "Business unit": "사업부", Active: "활성", Dormant: "휴면", Reactivated: "재활성",
    "Start date": "시작일", "End date": "종료일", "Apply period": "기간 적용",
    "Operations evidence dashboard": "운영 근거 대시보드", "Dashboard evidence could not be loaded.": "대시보드 근거를 불러오지 못했습니다.", Retry: "다시 시도", "Loading dashboard evidence...": "대시보드 근거를 불러오는 중입니다.",
    "External information": "외부 정보", "Select a metric to review the next action in its evidence post.": "수치를 선택하면 근거 글에서 다음 조치를 확인할 수 있습니다.",
    "All posts": "전체 글", "Classified events": "분류 Event", "External information (share of all posts)": "외부 정보 (전체 글 대비)", "{count} records · {percent}%": "{count}건 · {percent}%", "Analysis pending": "분석 대기", "Analysis failed": "분석 실패",
    "Status by work type": "업무 유형별 현황", "{events} events · {posts} posts": "{events} Event · {posts}글", "Observed processing intervals": "관측된 처리 구간", "Compare elapsed time for items with observed start and end events.": "시작과 종료 Event가 확인된 항목의 경과 시간을 비교하세요.",
    "Open {open} · resolved {resolved} · insufficient measurement evidence {missing}": "진행 중 {open}건 · 종료 확인 {resolved}건 · 측정 근거 부족 {missing}건", "Observed events by project": "프로젝트별 관측 Event", "Analyzing project connection": "프로젝트 연결 분석 중", "Confirmed elapsed time": "확정 경과 시간", "Elapsed time is calculated when all required start and end event evidence is observed.": "경과 시간은 필요한 시작·종료 Event 근거가 모두 관측될 때 계산됩니다.",
    ...
    "Post influence": "글 영향도", "Topic model influence over time": "시간 흐름별 Topic model influence", "This measures how much the topic- and organization-level model changes when the post is excluded, not business value.": "사업 가치가 아닌, 해당 글을 제외했을 때 Topic·조직 수준 모형이 변하는 정도입니다.", "Post influence is not available yet.": "글 영향도를 아직 확인할 수 없습니다.", "Review the event time and organizational membership of the posts being analyzed, then run the analysis again.": "분석 대상 글의 사건 시점과 조직 소속을 확인한 뒤 다시 분석하세요.", "Compare each post's influence and uncertainty, then review the source evidence.": "각 글의 영향도와 불확실성을 비교하고 원문 근거를 확인하세요.",
    ...
    "Public sources reviewed": "공개 출처 검토 완료",
    ...
    "Voice of Supplier": "공급사의 소리",
    "Voice of Employee": "임직원의 소리",
    "Voice of Business": "사업의 소리",
    ...
    "Open the cited public resource, then compare it with the highlighted passage or image detail from this post.":
      "인용된 공개 자료를 연 다음 이 글에서 강조된 문장이나 이미지 세부 내용과 비교하세요.",
    "Supported by a cited public resource": "인용된 공개 자료가 뒷받침함",
    "Conflicts with a cited public resource": "인용된 공개 자료와 충돌함",
    "Public research unavailable": "공개 조사를 사용할 수 없음",
    "Public source research is unavailable. Review the post's saved evidence, then try again later.": "공개 출처 조사를 사용할 수 없습니다. 글에 저장된 근거를 검토한 뒤 나중에 다시 시도하세요.",
    "No public research citations yet.": "아직 공개 조사 인용이 없습니다.",
    "Highlighted passage": "강조된 문장",
    "Image detail": "이미지 세부 내용",
    "Issue tickets": "이슈 티켓",
    "Key events": "주요 이벤트",
    ...
    "Leftover map explains {value} of raw residual after IRT main effects. Open this post to read {criterion}.":
      "잔여 지도가 IRT 주효과 이후 원잔차의 {value}를 설명합니다. {criterion} 기준을 읽으려면 이 글을 여세요.",
  ...
  zh: {
    ...
    "{start} ~ {end} · Event time": "{start} ~ {end} · 事件时间", "{start} or later · Event time": "{start}之后 · 事件时间", "Through {end} · Event time": "截至{end} · 事件时间", "All time · Event time": "全部期间 · 事件时间",
    "{days}d {hours}h {minutes}m {seconds}s": "{days}天 {hours}小时 {minutes}分 {seconds}秒",
    "Business unit": "事业部", Active: "活跃", Dormant: "休眠", Reactivated: "重新活跃", "Start date": "开始日期", "End date": "结束日期", "Apply period": "应用期间", "Operations evidence dashboard": "运营证据仪表板", "Dashboard evidence could not be loaded.": "无法加载仪表板证据。", Retry: "重试", "Loading dashboard evidence...": "正在加载仪表板证据…", "External information": "外部信息", "Select a metric to review the next action in its evidence post.": "选择指标，在证据文章中查看下一步操作。",
    "All posts": "所有文章", "Classified events": "已分类事件", "External information (share of all posts)": "外部信息（占所有文章）", "{count} records · {percent}%": "{count}条 · {percent}%", "Analysis pending": "等待分析", "Analysis failed": "分析失败", "Status by work type": "按工作类型统计", "{events} events · {posts} posts": "{events}个事件 · {posts}篇文章", "Observed processing intervals": "已观测处理区间", "Compare elapsed time for items with observed start and end events.": "比较已观测到开始和结束事件的项目所用时间。", "Open {open} · resolved {resolved} · insufficient measurement evidence {missing}": "进行中 {open} · 已解决 {resolved} · 测量证据不足 {missing}", "Observed events by project": "按项目查看已观测事件", "Analyzing project connection": "正在分析项目连接", "Confirmed elapsed time": "已确认用时", "Elapsed time is calculated when all required start and end event evidence is observed.": "仅在观测到全部所需的开始和结束事件证据后计算用时。",
    "Open {label} evidence": "打开{label}证据", "Next action:": "下一步：", "Items requiring additional review": "需要进一步审查的项目", "Additional review needed": "需要进一步审查", "When related evidence is found, this will be analyzed again automatically. Review the result afterward.": "找到相关证据后将自动重新分析，请随后查看结果。", "Open classification evidence post": "打开分类证据文章", "No external information was classified in the selected period. Check the period or access scope.": "所选期间没有已分类的外部信息。请检查期间或访问范围。", "No evidence analysis was completed in the selected period. Process pending analyses first.": "所选期间没有已完成的证据分析。请先处理等待分析的项目。", "No evidence can be analyzed in the selected period. Check the period or access scope.": "所选期间没有可分析的证据。请检查期间或访问范围。", "Reprocess {count} failed analyses, then review missing evidence again.": "重新处理 {count} 个失败分析，然后再次审查缺失证据。",
    "Post influence": "文章影响度", "Topic model influence over time": "主题模型影响度随时间变化", "This measures how much the topic- and organization-level model changes when the post is excluded, not business value.": "这衡量排除该文章后主题和组织层模型的变化程度，并非业务价值。", "Post influence is not available yet.": "文章影响度尚不可用。", "Review the event time and organizational membership of the posts being analyzed, then run the analysis again.": "检查待分析文章的事件时间和组织归属，然后重新分析。", "Compare each post's influence and uncertainty, then review the source evidence.": "比较每篇文章的影响度和不确定性，然后查看来源证据。", "Topic {topic} time states": "主题 {topic} 时间状态", "{context} model influence table": "{context} 模型影响度表", "Compare influence and uncertainty together; treat equal values as ties.": "同时比较影响度和不确定性；相同值视为并列。", State: "状态", "Model influence": "模型影响度", Uncertainty: "不确定性", "Membership evidence": "归属证据", "Source post": "来源文章", "Review analysis basis": "查看分析依据", "Knowledge cutoff": "知识截止时间", "Topic count": "主题数",
    "Unknown": "未知",
    Language: "语言",
    unresolved: "未解决",
    ...
    "Public sources reviewed": "公开来源已审查",
    ...
    "Researching...": "正在核查…",
    "Open the cited public resource, then compare it with the highlighted passage or image detail from this post.":
      "打开引用的公开资料，再与本帖中突出显示的段落或图像细节进行比较。",
    "Supported by a cited public resource": "被引用的公开资料支持",
    "Conflicts with a cited public resource": "与被引用的公开资料冲突",
    "Public research unavailable": "无法进行公开核查",
    "Public source research is unavailable. Review the post's saved evidence, then try again later.": "暂时无法核查公开来源。请先查看帖子中已保存的证据，稍后再试。",
    "No public research citations yet.": "尚无公开核查引用。",
    "Highlighted passage": "突出显示的段落",
    "Image detail": "图像细节",
    "Issue tickets": "问题工单",
    "Key events": "关键事件",
    ...
    "Leftover map explains {value} of raw residual after IRT main effects. Open this post to read {criterion}.":
      "残差图解释 IRT 主效应后原始残差的 {value}。打开这篇帖子阅读 {criterion}。",
    "Read observed Y {observed} and expected E {expected} after IRT main effects, then open this post.":
  ...
  ja: {
    ...
    "{start} ~ {end} · Event time": "{start} ~ {end} · イベント時刻", "{start} or later · Event time": "{start}以降 · イベント時刻", "Through {end} · Event time": "{end}まで · イベント時刻", "All time · Event time": "全期間 · イベント時刻",
    "{days}d {hours}h {minutes}m {seconds}s": "{days}日 {hours}時間 {minutes}分 {seconds}秒",
    "Business unit": "事業部", Active: "アクティブ", Dormant: "休止", Reactivated: "再アクティブ", "Start date": "開始日", "End date": "終了日", "Apply period": "期間を適用", "Operations evidence dashboard": "運用根拠ダッシュボード", "Dashboard evidence could not be loaded.": "ダッシュボードの根拠を読み込めませんでした。", Retry: "再試行", "Loading dashboard evidence...": "ダッシュボードの根拠を読み込み中…", "External information": "外部情報", "Select a metric to review the next action in its evidence post.": "指標を選択し、根拠投稿で次の対応を確認してください。",
    "All posts": "すべての投稿", "Classified events": "分類済みイベント", "External information (share of all posts)": "外部情報（全投稿に占める割合）", "{count} records · {percent}%": "{count}件 · {percent}%", "Analysis pending": "分析待ち", "Analysis failed": "分析失敗", "Status by work type": "業務タイプ別状況", "{events} events · {posts} posts": "{events}件のイベント · {posts}件の投稿", "Observed processing intervals": "観測された処理区間", "Compare elapsed time for items with observed start and end events.": "開始・終了イベントが観測された項目の経過時間を比較してください。", "Open {open} · resolved {resolved} · insufficient measurement evidence {missing}": "進行中 {open} · 解決済み {resolved} · 測定根拠不足 {missing}", "Observed events by project": "プロジェクト別の観測イベント", "Analyzing project connection": "プロジェクト接続を分析中", "Confirmed elapsed time": "確定経過時間", "Elapsed time is calculated when all required start and end event evidence is observed.": "必要な開始・終了イベントの根拠がすべて観測された時点で経過時間を計算します。",
    "Open {label} evidence": "{label}の根拠を開く", "Next action:": "次の対応：", "Items requiring additional review": "追加確認が必要な項目", "Additional review needed": "追加確認が必要", "When related evidence is found, this will be analyzed again automatically. Review the result afterward.": "関連根拠が見つかると自動的に再分析されます。その後、結果を確認してください。", "Open classification evidence post": "分類根拠の投稿を開く", "No external information was classified in the selected period. Check the period or access scope.": "選択期間に分類された外部情報はありません。期間またはアクセス範囲を確認してください。", "No evidence analysis was completed in the selected period. Process pending analyses first.": "選択期間に完了した根拠分析はありません。まず分析待ちを処理してください。", "No evidence can be analyzed in the selected period. Check the period or access scope.": "選択期間に分析できる根拠はありません。期間またはアクセス範囲を確認してください。", "Reprocess {count} failed analyses, then review missing evidence again.": "失敗した分析 {count}件を再処理し、根拠不足を再確認してください。",
    "Post influence": "投稿影響度", "Topic model influence over time": "時間経過に伴うトピックモデル影響度", "This measures how much the topic- and organization-level model changes when the post is excluded, not business value.": "事業価値ではなく、その投稿を除外したときにトピック・組織レベルのモデルが変化する度合いです。", "Post influence is not available yet.": "投稿影響度はまだ確認できません。", "Review the event time and organizational membership of the posts being analyzed, then run the analysis again.": "分析対象投稿のイベント時刻と組織所属を確認してから再分析してください。", "Compare each post's influence and uncertainty, then review the source evidence.": "各投稿の影響度と不確実性を比較し、原文の根拠を確認してください。", "Topic {topic} time states": "トピック {topic} の時間状態", "{context} model influence table": "{context}のモデル影響度表", "Compare influence and uncertainty together; treat equal values as ties.": "影響度と不確実性を併せて比較し、同値は同順位として確認してください。", State: "状態", "Model influence": "モデル影響度", Uncertainty: "不確実性", "Membership evidence": "所属根拠", "Source post": "原文投稿", "Review analysis basis": "分析基準を確認", "Knowledge cutoff": "知識カットオフ", "Topic count": "トピック数",
    "Unknown": "不明",
    "5W1H": "5W1H",
    Who: "誰が",
    What: "何を",
    ...
    "Public sources reviewed": "公開情報源を確認済み",
    ...
    "Researching...": "調査中...",
    "Open the cited public resource, then compare it with the highlighted passage or image detail from this post.":
      "引用した公開資料を開き、この投稿で強調された文章または画像の詳細と比較してください。",
    "Supported by a cited public resource": "引用した公開資料が支持",
    "Conflicts with a cited public resource": "引用した公開資料と矛盾",
    "Public research unavailable": "公開調査を利用できません",
    "Public source research is unavailable. Review the post's saved evidence, then try again later.": "公開情報源を調査できません。投稿に保存された根拠を確認してから、後でもう一度お試しください。",
    "No public research citations yet.": "公開調査の引用はまだありません。",
    "Highlighted passage": "強調された文章",
    "Image detail": "画像の詳細",
    ...
    "Leftover map explains {value} of raw residual after IRT main effects. Open this post to read {criterion}.":
      "残差マップはIRT主効果後の生の残差の {value} を説明します。この投稿を開いて {criterion} を読んでください。",
    "Read observed Y {observed} and expected E {expected} after IRT main effects, then open this post.":
  ...
  vi: {
    ...
    "Public sources reviewed": "Đã xem xét nguồn công khai",
    ...
    "Open the cited public resource, then compare it with the highlighted passage or image detail from this post.":
      "Mở tài liệu công khai được trích dẫn, rồi so sánh với đoạn văn được đánh dấu hoặc chi tiết hình ảnh trong bài này.",
    "Supported by a cited public resource": "Được tài liệu công khai trích dẫn hỗ trợ",
    "Conflicts with a cited public resource": "Mâu thuẫn với tài liệu công khai được trích dẫn",
    "Public research unavailable": "Không thể nghiên cứu công khai",
    "Public source research is unavailable. Review the post's saved evidence, then try again later.": "Hiện không thể nghiên cứu nguồn công khai. Hãy xem bằng chứng đã lưu trong bài viết rồi thử lại sau.",
    "No public research citations yet.": "Chưa có trích dẫn nghiên cứu công khai.",
    "Highlighted passage": "Đoạn văn được đánh dấu",
    "Image detail": "Chi tiết hình ảnh",
    ...
    "Leftover map explains {value} of raw residual after IRT main effects. Open this post to read {criterion}.":
      "Bản đồ phần dư giải thích {value} của phần dư thô sau hiệu ứng chính IRT. Mở bài viết này để đọc {criterion}.",
    "Read observed Y {observed} and expected E {expected} after IRT main effects, then open this post.":
