...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    "Ask an administrator to enable public-source verification, then retry.": "관리자에게 공개 자료 검증 사용 설정을 요청한 후 다시 시도하세요.",
  ...
  zh: {
    ...
    "Ask an administrator to enable public-source verification, then retry.": "请管理员启用公开资料核验，然后重试。",
  ...
  ja: {
    ...
    "Ask an administrator to enable public-source verification, then retry.": "管理者に公開資料の検証を有効にするよう依頼してから、再試行してください。",
  ...
  vi: {
    ...
    "Ask an administrator to enable public-source verification, then retry.": "Hãy yêu cầu quản trị viên bật xác minh nguồn công khai rồi thử lại.",
