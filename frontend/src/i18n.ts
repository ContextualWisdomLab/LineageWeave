...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    "Public information could not be checked. Try again later.": "공개 정보를 확인하지 못했습니다. 잠시 후 다시 시도하세요.",
    ...
    "No eligible cited public claims were found. Review the cited posts.": "검증할 수 있는 공개 주장이 인용문에 없습니다. 인용된 글을 확인하세요.",
    "Public verification is unavailable. Try again later.": "공개 정보 확인을 사용할 수 없습니다. 나중에 다시 시도하세요.",
    "Turn on public information checks, then ask again.": "공개 정보 확인을 켠 뒤 다시 질문하세요.",
    "Review the cited posts or try the public information check again later.": "인용된 글을 검토하거나 잠시 후 공개 정보 확인을 다시 시도하세요.",
    "Open the cited posts to review the available evidence.": "인용된 글을 열어 확인 가능한 근거를 검토하세요.",
    "Compare the public sources with the cited posts before deciding what to do next.": "다음 행동을 결정하기 전에 공개 자료와 인용된 글을 비교하세요.",
    "Find another reliable source before relying on this claim.": "이 주장을 활용하기 전에 신뢰할 수 있는 다른 자료를 찾으세요.",
    "Open the cited posts and review their evidence.": "인용된 글을 열어 근거를 검토하세요.",
    Ask: "질의",
    "Asking...": "질의 중...",
    Answer: "답변",
    "Cited posts": "인용된 글",
  ...
  zh: {
    ...
    "Public information could not be checked. Try again later.": "无法核验公开信息。请稍后重试。",
    ...
    "No eligible cited public claims were found. Review the cited posts.": "引用内容中没有可核验的公开声明。请查看引用帖子。",
    "Public verification is unavailable. Try again later.": "公开信息核验暂不可用。请稍后重试。",
    "Turn on public information checks, then ask again.": "开启公开信息核验后再次提问。",
    "Review the cited posts or try the public information check again later.": "查看引用文章，或稍后重试公开信息核验。",
    "Open the cited posts to review the available evidence.": "打开引用文章，查看现有证据。",
    "Compare the public sources with the cited posts before deciding what to do next.": "决定下一步操作前，请比较公开资料与引用文章。",
    "Find another reliable source before relying on this claim.": "采用此声明前，请查找其他可靠资料。",
    "Open the cited posts and review their evidence.": "打开引用文章并查看其证据。",
    Ask: "提问",
    "Asking...": "正在提问...",
    Answer: "回答",
    "Cited posts": "引用文章",
  ...
  ja: {
    ...
    "Public information could not be checked. Try again later.": "公開情報を確認できませんでした。しばらくしてから再試行してください。",
    ...
    "No eligible cited public claims were found. Review the cited posts.": "引用内に検証できる公開主張がありません。引用された投稿を確認してください。",
    "Public verification is unavailable. Try again later.": "公開情報の確認を利用できません。後でもう一度お試しください。",
    "Turn on public information checks, then ask again.": "公開情報の確認を有効にして、もう一度質問してください。",
    "Review the cited posts or try the public information check again later.": "引用された投稿を確認するか、しばらくしてから公開情報の確認を再試行してください。",
    "Open the cited posts to review the available evidence.": "引用された投稿を開き、確認できる根拠を見直してください。",
    "Compare the public sources with the cited posts before deciding what to do next.": "次の行動を決める前に、公開資料と引用された投稿を比較してください。",
    "Find another reliable source before relying on this claim.": "この主張を利用する前に、別の信頼できる資料を探してください。",
    "Open the cited posts and review their evidence.": "引用された投稿を開き、根拠を確認してください。",
    Ask: "質問する",
    "Asking...": "質問中...",
    Answer: "回答",
    "Cited posts": "引用された投稿",
  ...
  vi: {
    ...
    "Public information could not be checked. Try again later.": "Chưa thể kiểm tra thông tin công khai. Hãy thử lại sau.",
    ...
    "No eligible cited public claims were found. Review the cited posts.": "Không có tuyên bố công khai đủ điều kiện trong phần trích dẫn. Hãy xem các bài viết được trích dẫn.",
    "Public verification is unavailable. Try again later.": "Không thể kiểm tra thông tin công khai. Hãy thử lại sau.",
    "Turn on public information checks, then ask again.": "Bật kiểm tra thông tin công khai rồi hỏi lại.",
    "Review the cited posts or try the public information check again later.": "Xem các bài viết được trích dẫn hoặc thử kiểm tra thông tin công khai lại sau.",
    "Open the cited posts to review the available evidence.": "Mở các bài viết được trích dẫn để xem bằng chứng hiện có.",
    "Compare the public sources with the cited posts before deciding what to do next.": "So sánh nguồn công khai với các bài viết được trích dẫn trước khi quyết định bước tiếp theo.",
    "Find another reliable source before relying on this claim.": "Tìm thêm một nguồn đáng tin cậy trước khi sử dụng tuyên bố này.",
    "Open the cited posts and review their evidence.": "Mở các bài viết được trích dẫn và xem bằng chứng.",
    Ask: "Hỏi",
    "Asking...": "Đang hỏi...",
    Answer: "Câu trả lời",
