...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    "Verification could not be completed. Check the request and try again.": "검증을 완료하지 못했습니다. 요청 내용을 확인한 뒤 다시 시도하세요.",
  ...
  zh: {
    ...
    "Verification could not be completed. Check the request and try again.": "无法完成验证。请检查请求后重试。",
  ...
  ja: {
    ...
    "Verification could not be completed. Check the request and try again.": "検証を完了できませんでした。リクエスト内容を確認してから、もう一度お試しください。",
  ...
  vi: {
    ...
    "Verification could not be completed. Check the request and try again.": "Không thể hoàn tất xác minh. Hãy kiểm tra yêu cầu rồi thử lại.",
