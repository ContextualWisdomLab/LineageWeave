...
const CUSTOMER_COPY: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "Reviewed detail": "Reviewed detail",
    "Project listed in the record": "Project listed in the record",
    ...
    "Open linked record {number}": "Open linked record {number}",
    ...
    "Records are ordered by recent and related activity. Open a record to review its evidence.": "Records are ordered by recent and related activity. Open a record to review its evidence.",
    "Use these values to compare ordering signals, not as calibrated scores.": "Use these values to compare ordering signals, not as calibrated scores.",
    ...
    "These links show people, organizations, teams, and records. Open Event Lineage to review record-to-record history.": "These links show people, organizations, teams, and records. Open Event Lineage to review record-to-record history.",
  ...
  ko: {
    ...
    "Reviewed detail": "검토된 세부 정보",
    "Project listed in the record": "기록에 표시된 프로젝트",
    ...
    "Open linked record {number}": "연결된 기록 {number} 열기",
    ...
    "Records are ordered by recent and related activity. Open a record to review its evidence.": "최근 활동과 관련성을 기준으로 기록을 정렬했습니다. 기록을 열어 근거를 검토하세요.",
    "Use these values to compare ordering signals, not as calibrated scores.": "이 값은 정렬 신호를 비교할 때만 사용하고 보정된 점수로 해석하지 마세요.",
    "Related detail": "관련 세부 정보",
    "Record detail": "기록 세부 정보",
    ...
    "These links show people, organizations, teams, and records. Open Event Lineage to review record-to-record history.": "이 연결은 사람, 조직, 팀, 기록을 보여 줍니다. 기록 간 이력을 확인하려면 이벤트 계보를 여세요.",
...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    "This record has no readable content. Open the source record or try again after content is added.":
      "이 기록에는 읽을 수 있는 내용이 없습니다. 원본 기록을 열거나 내용이 추가된 뒤 다시 시도하세요.",
    ...
    "Search records and evidence": "기록과 근거 검색",
    Search: "검색",
    "Search includes record text and supporting evidence.": "기록 본문과 뒷받침 근거를 함께 검색합니다.",
    ...
    "No other visible records share this group yet. Review Keyman and evaluation, then try again after more records arrive.": "아직 이 그룹을 공유하는 다른 표시 가능한 기록이 없습니다. 핵심 담당자와 평가를 검토한 뒤 기록이 더 들어오면 다시 시도하세요.",
    "VOC evidence": "VOC 근거",
    ...
    Tickets: "티켓",
	    Summary: "요약",
	    "The last saved summary is shown. Refresh it to check for updates.": "마지막 저장 요약을 표시합니다. 업데이트를 확인하려면 새로고침하세요.",
    ...
    "Print related information": "관련 정보 인쇄",
    Legend: "범례",
  ...
  zh: {
    ...
    Search: "搜索",
    "Search includes record text and supporting evidence.": "搜索范围包括记录正文和支持证据。",
    ...
    "No other visible records share this group yet. Review Keyman and evaluation, then try again after more records arrive.": "此组中暂时没有其他可见记录。请先查看关键人员和评估，并在有更多记录后重试。",
    "VOC evidence": "客户之声证据",
    ...
    Tickets: "工单",
	    Summary: "摘要",
	    "The last saved summary is shown. Refresh it to check for updates.": "正在显示上次保存的摘要。请刷新以检查更新。",
    ...
    "Print related information": "打印相关信息",
    Legend: "图例",
    "Node types use shape plus text, never color alone. Truth status is labeled on every edge.":
  ...
  ja: {
    ...
    "Fused rankings": "ランキング一覧",
    "Ranked posts": "ランキング一覧",
    ...
    "This record has no readable content. Open the source record or try again after content is added.":
      "この記録には読める内容がありません。原典の記録を開くか、内容が追加された後に再試行してください。",
    ...
    Search: "検索",
    "Search includes record text and supporting evidence.": "記録本文と裏付けとなる根拠を検索します。",
    ...
    "No other visible records share this group yet. Review Keyman and evaluation, then try again after more records arrive.": "このグループを共有する他の表示可能な記録はまだありません。キーパーソンと評価を確認し、記録が増えた後に再試行してください。",
    "VOC evidence": "VOCの証拠",
    ...
    Tickets: "チケット",
    Summary: "概要",
    "The last saved summary is shown. Refresh it to check for updates.": "保存済みの最新の要約を表示しています。更新を確認するには再読み込みしてください。",
    ...
    "Print related information": "関連情報を印刷",
    Legend: "凡例",
    "Node types use shape plus text, never color alone. Truth status is labeled on every edge.":
  ...
  vi: {
    ...
    "Fused rankings": "Danh sách xếp hạng",
    ...
    "This record has no readable content. Open the source record or try again after content is added.":
      "Bản ghi này không có nội dung có thể đọc. Mở bản ghi nguồn hoặc thử lại sau khi nội dung được bổ sung.",
    ...
    "Use these recorded details to confirm the record with your source system.": "Hãy dùng các chi tiết đã ghi nhận để xác nhận bản ghi trong hệ thống nguồn.",
    "Search and filter posts": "Tìm kiếm và lọc bài viết",
    "Search records and evidence": "Tìm kiếm bản ghi và bằng chứng",
    Search: "Tìm",
    "Search includes record text and supporting evidence.": "Tìm trong nội dung bản ghi và bằng chứng hỗ trợ.",
    ...
    "No other visible records share this group yet. Review Keyman and evaluation, then try again after more records arrive.": "Chưa có bản ghi hiển thị nào khác trong nhóm này. Xem người liên hệ chính và phần đánh giá, rồi thử lại khi có thêm bản ghi.",
    ...
    Summary: "Tóm tắt",
    "The last saved summary is shown. Refresh it to check for updates.": "Đang hiển thị bản tóm tắt đã lưu gần nhất. Hãy làm mới để kiểm tra cập nhật.",
    ...
    "Print related information": "In thông tin liên quan",
    Legend: "Chú giải",
    "Node types use shape plus text, never color alone. Truth status is labeled on every edge.":
