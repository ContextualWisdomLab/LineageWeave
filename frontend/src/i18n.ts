...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    "Finished by": "끝 포함",
    Equals: "같은 구간",
    "Click Contains to open the revised quote.": "포함을 눌러 개정 견적을 여세요.",
  ...
  zh: {
    ...
    "Finished by": "结束包含",
    Equals: "相同区间",
    "Click Contains to open the revised quote.": "点击包含以打开修订报价。",
    "{label} — {date}": "{label} — {date}",
  ...
  ja: {
    ...
    "Finished by": "終了を含む",
    Equals: "同じ区間",
    "Click Contains to open the revised quote.": "含むを押して改訂見積を開いてください。",
    "{label} — {date}": "{label} — {date}",
  ...
  vi: {
    ...
    Equals: "Cùng khoảng",
    "Click Contains to open the revised quote.": "Nhấn Chứa để mở báo giá đã sửa.",
    "{label} — {date}": "{label} — {date}",
