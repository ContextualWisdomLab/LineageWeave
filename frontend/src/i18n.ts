...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ...
  zh: {
    ...
    "Read leftover map rank {rank}, observed Y {observed}, expected E {expected}, and unexplained share {value} after IRT main effects, then open this post.":
      "阅读 IRT 主效应后的残余图秩 {rank}、观测 Y {observed}、期望 E {expected} 与未解释份额 {value}，然后打开这篇帖子。",
    "Leftover map rank 0 means no leftover structure after IRT main effects. Read observed Y {observed}, expected E {expected}, and unexplained share {value}, then open this post.":
      "残余图秩 0 表示 IRT 主效应后没有残余结构。阅读观测 Y {observed}、期望 E {expected} 与未解释份额 {value}，然后打开这篇帖子。",
  },
  ja: {
    "Unknown": "不明",
    "5W1H": "5W1H",
    ...
    "Read leftover map rank {rank}, observed Y {observed}, expected E {expected}, and unexplained share {value} after IRT main effects, then open this post.":
      "IRT主効果後の残差マップランク {rank}、観測 Y {observed}、期待 E {expected}、未説明の割合 {value} を読んでから、この投稿を開いてください。",
    "Leftover map rank 0 means no leftover structure after IRT main effects. Read observed Y {observed}, expected E {expected}, and unexplained share {value}, then open this post.":
      "残差マップランク 0 は IRT 主効果後に残差構造がないことを示します。観測 Y {observed}、期待 E {expected}、未説明の割合 {value} を読んでから、この投稿を開いてください。",
  },
  vi: {
    "Unknown": "Không rõ",
    "5W1H": "5W1H",
    ...
    "Read leftover map rank {rank}, observed Y {observed}, expected E {expected}, and unexplained share {value} after IRT main effects, then open this post.":
      "Đọc hạng bản đồ phần dư {rank}, Y quan sát {observed}, E kỳ vọng {expected}, và phần chưa giải thích {value} sau hiệu ứng chính IRT, rồi mở bài viết này.",
    "Leftover map rank 0 means no leftover structure after IRT main effects. Read observed Y {observed}, expected E {expected}, and unexplained share {value}, then open this post.":
      "Hạng bản đồ phần dư 0 nghĩa là không có cấu trúc phần dư sau hiệu ứng chính IRT. Đọc Y quan sát {observed}, E kỳ vọng {expected}, và phần chưa giải thích {value}, rồi mở bài viết này.",
  },
};
