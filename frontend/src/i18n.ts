...
const OPERATIONS_TRANSLATIONS: Record<"zh" | "ja" | "vi", Record<string, string>> = {
  zh: {
    "Start date": "开始日期", "End date": "结束日期", "Apply period": "应用期间", "Voice evidence overview": "声音证据概览", "All periods": "全部期间", "{start} or later": "{start}之后", "Through {end}": "截至{end}",
    ...
    "Reports and evidence alerts": "报告与证据提醒", "{count} evidence documents are linked to this report.": "此报告关联了{count}份证据文档。", "You can subscribe to evidence-change alerts.": "您可以订阅证据变更提醒。", "Connect evidence to enable change-alert subscriptions.": "关联证据以启用变更提醒订阅。",
  },
  ja: {
    "Start date": "開始日", "End date": "終了日", "Apply period": "期間を適用", "Voice evidence overview": "Voice根拠の概要", "All periods": "全期間", "{start} or later": "{start}以降", "Through {end}": "{end}まで",
    ...
    "Claim investigation": "クレーム原因調査", "Rebid and handover": "再入札と引継ぎ", "Recurring issue": "反復問題", "Affected order": "発生受注", "Specification change": "仕様変更", "Originating order": "原因受注", "Sales pool": "受注プール", Discussion: "協議内容", Counterparty: "協議相手", "Our owner": "当社担当者", Decision: "後続決定", "Business relationship": "業務関係", "Recurring pattern": "反復パターン", "Improvement action": "改善対応", "Rebid response": "再入札対応", "Handover gap": "引継ぎ空白", "In progress": "進行中", Completed: "完了", "Timing evidence needed": "時間根拠が必要", "Claim received": "クレーム受付", "Cause confirmed": "原因確定", "Rebid started": "再入札開始", "Response submitted": "対応提出", "Rebid response requested": "再入札対応依頼", "Rebid decision recorded": "再入札意思決定記録", "Handover started": "引継ぎ開始", "Handover completed": "引継ぎ完了", "Handover accepted": "引継ぎ受入確認", "Record creation date": "記録作成日", Order: "受注", Sales: "営業", "Business management": "事業管理", "Open the start evidence and track the next observed event.": "開始根拠を開き、次の観測イベントを追跡してください。", "Open the start and end evidence, then review the elapsed time.": "開始・終了根拠を開き、経過時間を確認してください。", "Find and connect the required start and end evidence, then review the refreshed interval.": "必要な開始・終了根拠を見つけて接続し、更新区間を確認してください。",
    "Reports and evidence alerts": "レポートと根拠通知", "{count} evidence documents are linked to this report.": "このレポートには{count}件の根拠文書が関連付けられています。", "You can subscribe to evidence-change alerts.": "根拠変更の通知を購読できます。", "Connect evidence to enable change-alert subscriptions.": "根拠を接続して変更通知の購読を有効にしてください。",
  },
  vi: {
    "Start date": "Ngày bắt đầu", "End date": "Ngày kết thúc", "Apply period": "Áp dụng khoảng thời gian", "Voice evidence overview": "Tổng quan bằng chứng tiếng nói", "All periods": "Toàn bộ thời gian", "{start} or later": "Từ {start}", "Through {end}": "Đến {end}",
    ...
    "Reports and evidence alerts": "Báo cáo và cảnh báo bằng chứng", "{count} evidence documents are linked to this report.": "Có {count} tài liệu bằng chứng được liên kết với báo cáo này.", "You can subscribe to evidence-change alerts.": "Bạn có thể đăng ký cảnh báo thay đổi bằng chứng.", "Connect evidence to enable change-alert subscriptions.": "Liên kết bằng chứng để bật đăng ký cảnh báo thay đổi.",
  },
};
...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    "End date": "종료일",
    "Apply period": "기간 적용",
    "Operations evidence dashboard": "운영 근거 대시보드",
    "Voice evidence overview": "글 유형 근거 현황",
    "All periods": "전체 기간",
    "{start} or later": "{start} 이후",
    "Through {end}": "{end} 이전",
    "Dashboard evidence could not be loaded.": "대시보드 근거를 불러오지 못했습니다.",
    "Loading dashboard evidence...": "대시보드 근거를 불러오는 중입니다.",
    "Select a value, then open its source post to confirm the next action.": "수치를 선택한 뒤 원본 글을 열어 다음 조치를 확인하세요.",
    "All posts": "전체 글",
    "Cited case events": "근거 확인된 사건 Event",
    "{count} posts": "{count}건",
    "{count} posts · {percent}%": "{count}건 · {percent}%",
    "Awaiting analysis": "분석 대기",
    "Analysis failed": "분석 실패",
    "Status by work type": "업무 유형별 현황",
    "{events} case events · {posts} posts": "사건 Event {events}건 · 글 {posts}건",
    "Observed processing intervals": "관측된 처리 구간",
    "Compare elapsed time for items with observed start and end events.": "시작과 종료 Event가 확인된 항목의 경과 시간을 비교하세요.",
    "{open} in progress · {resolved} completed · {missing} need timing evidence": "진행 중 {open}건 · 종료 확인 {resolved}건 · 측정 근거 부족 {missing}건",
    "Observed events by project": "프로젝트별 관측 Event",
    "Finding a related project": "관련 프로젝트 확인 중",
    "Confirmed elapsed time": "확정 경과 시간",
    "Elapsed time is calculated after both required start and end evidence are observed.": "경과 시간은 필요한 시작·종료 사건 근거가 모두 관측될 때 계산됩니다.",
    "{days}d {hours}h {minutes}m {seconds}s": "{days}일 {hours}시간 {minutes}분 {seconds}초",
    "Open {label} evidence": "{label} 근거 열기",
    "Items requiring additional evidence": "추가 확인이 필요한 항목",
    "Additional evidence needed": "추가 확인 필요",
    "{label}: Find and connect the related evidence, then review the refreshed result.": "{label}: 관련 근거를 찾아 연결한 뒤 갱신된 결과를 확인하세요.",
    "Open classification evidence": "분류 근거 글 열기",
    "No external information was classified in this period. Check the period or your access scope.": "선택 기간에 분류된 외부 정보가 없습니다. 기간이나 접근 범위를 확인하세요.",
    "No evidence has completed analysis in this period. Process the awaiting items first.": "선택 기간에 분석 완료된 근거가 없습니다. 분석 대기 건부터 처리하세요.",
    "No evidence can be analyzed in this period. Check the period or your access scope.": "선택 기간에 분석할 수 있는 근거가 없습니다. 기간이나 접근 범위를 확인하세요.",
    "Reprocess {count} failed analyses, then check again for missing evidence.": "분석 실패 {count}건을 재처리한 뒤 근거 누락 여부를 다시 확인하세요.",
    "Post influence": "글 영향도",
    "Important posts over time": "시간 흐름별 주요 글",
    "Compare how topic trends and organization-level results change when a post is excluded.": "글을 제외했을 때 주제 흐름과 조직별 결과가 얼마나 달라지는지 확인하세요.",
    "Post influence is not available yet.": "글 영향도를 아직 확인할 수 없습니다.",
    "Confirm event dates and organization memberships for the selected posts, then run the analysis again.": "분석 대상 글의 사건 시점과 조직 소속을 확인한 뒤 다시 분석하세요.",
    "Compare each post's influence and uncertainty, then open its source evidence.": "각 글의 영향도와 불확실성을 비교한 뒤 원문 근거를 확인하세요.",
    "Topic {number}": "주제 {number}",
    "Topic {number} status over time": "주제 {number} 시간 상태",
    "Topic {number} change history": "주제 {number} 변화 이력",
    Active: "활성",
    Dormant: "휴면",
    Reactivated: "재활성",
    Started: "시작",
    ...
    Ended: "종료",
    "Business unit": "사업부",
    "Open event evidence": "사건 근거 열기",
    "{label} influence table": "{label} 영향도 표",
    "Compare influence and uncertainty together; identical values are ties.": "영향도와 불확실성을 함께 비교하고 같은 값은 동점으로 확인하세요.",
    "Event date": "사건 발생일",
    Status: "상태",
    Influence: "영향도",
    Uncertainty: "불확실성",
    "Membership value": "소속 반영값",
    "Open membership evidence": "소속 근거 열기",
    "Open influential post": "영향 글 열기",
    "Review analysis basis": "분석 기준 확인",
    "Evidence included through": "근거 반영 시각",
    "Topic count": "주제 수",
    "Claim investigation": "클레임 원인 규명",
    "Rebid and handover": "재입찰 · 인수인계",
    "Recurring issue": "반복 이슈",
    "Affected order": "발생 수주",
    "Specification change": "사양 변경",
    "Originating order": "원인 수주",
    "Sales pool": "수주 Pool",
    Discussion: "협의 내용",
    Counterparty: "협의 상대",
    "Our owner": "우리측 담당자",
    Decision: "이어진 결정",
    "Business relationship": "업무 관계",
    "Recurring pattern": "반복 유형",
    "Improvement action": "개선 과제",
    "Rebid response": "재입찰 대응",
    "Handover gap": "인수인계 공백",
    "In progress": "진행 중",
    Completed: "종료 확인",
    "Timing evidence needed": "측정 근거 부족",
    "Claim received": "클레임 접수",
    "Cause confirmed": "원인 확정",
    "Rebid started": "재입찰 시작",
    "Response submitted": "대응 제출",
    "Rebid response requested": "재입찰 대응 요청",
    "Rebid decision recorded": "재입찰 의사결정",
    "Handover started": "인수인계 시작",
    "Handover completed": "인수인계 완료",
    "Handover accepted": "인수 확인",
    "Record creation date": "기록 생성일",
    Order: "수주",
    Sales: "영업",
    "Business management": "사업 관리",
    "Open the start evidence and track the next observed event.": "시작 근거를 열고 다음 관측 Event를 추적하세요.",
    "Open the start and end evidence, then review the elapsed time.": "시작·종료 근거를 연 뒤 경과 시간을 검토하세요.",
    "Find and connect the required start and end evidence, then review the refreshed interval.": "필요한 시작·종료 근거를 찾아 연결한 뒤 갱신된 처리 구간을 검토하세요.",
    ...
    "Derived from post evidence": "글 근거에서 확인",
    "Recorded extraction": "기록된 추출",
    "Project evidence from this post": "이 글에서 확인한 프로젝트 근거",
    "Additional classified records": "추가로 분류된 기록",
    ...
    "The original text of this post was not imported, so its summary and related details are unavailable.": "원천 본문이 수집되지 않아 요약과 관련 상세 정보를 사용할 수 없습니다.",
    "Open the post directly or ask the source owner to re-import it with its body.": "글을 직접 열어 확인하거나 원문 담당자에게 본문 포함 재등록을 요청하세요.",
    ...
    "Search related evidence": "관련 근거 검색",
    Search: "검색",
    "Search includes post text and related evidence.": "게시물 본문과 관련 근거를 함께 검색합니다.",
    ...
    "Project history could not be loaded.": "프로젝트 이력을 불러오지 못했습니다.",
    "Retry the same project and evidence cutoff.": "같은 프로젝트와 근거 기준 시점으로 다시 시도하세요.",
    "This case has no explicit project key.": "이 사례에는 명시된 프로젝트 키가 없습니다.",
    "Open the source evidence and connect an explicit project code or accepted semantic project key.": "원문 근거를 열고 명시된 프로젝트 코드나 승인된 의미 프로젝트 키를 연결하세요.",
    ...
    "Ask a catalog manager to register this cited product, then run product analysis again.": "카탈로그 담당자에게 이 근거 제품의 등록을 요청한 뒤 제품 분석을 다시 실행하세요.",
    "Ask a catalog manager to distinguish the matching products, then run product analysis again.": "카탈로그 담당자에게 일치 제품의 구분을 요청한 뒤 제품 분석을 다시 실행하세요.",
    "Retry product analysis after catalog access is restored.": "제품 카탈로그를 다시 사용할 수 있게 되면 제품 분석을 재시도하세요.",
    "No product was identified in this post.": "이 글에서 확인된 제품이 없습니다.",
    "Product evidence analysis is in progress.": "제품 근거를 분석하고 있습니다.",
    "Product evidence is not available yet.": "제품 근거를 아직 확인할 수 없습니다.",
    "Historical product evidence is not available.": "당시 시점의 제품 근거를 확인할 수 없습니다.",
    "Refresh this post after product analysis is available.": "제품 분석을 사용할 수 있게 된 뒤 이 글을 다시 확인하세요.",
    "Run product analysis again, then review source evidence and linked products.": "제품 분석을 다시 실행한 뒤 원문 근거와 연결된 제품을 확인하세요.",
    "Review this post's product evidence separately from the historical body.": "현재 글의 제품 근거와 당시 본문을 구분해 확인하세요.",
    "Open the linked products and source evidence.": "연결된 제품과 원문 근거를 확인하세요.",
    "Open the source text and confirm that no product was mentioned.": "원문을 열어 제품 언급이 없는지 확인하세요.",
    "Review product evidence again after analysis finishes.": "분석이 끝난 뒤 제품 근거를 다시 확인하세요.",
    "Ask an administrator to enable product analysis, then review this post again.": "관리자에게 제품 분석 사용 설정을 요청한 뒤 이 글을 다시 확인하세요.",
    "Run product analysis again, then review the result.": "제품 분석을 다시 실행한 뒤 결과를 확인하세요.",
    ...
    "Before connecting a customer, compare each source identifier with the related posts and organization evidence.": "고객을 연결하기 전에 각 원본 식별자를 관련 글 및 조직 근거와 비교하세요.",
    ...
    "Evidence at selected time": "선택한 시점의 근거",
    "All cited evidence was available by this time": "인용된 근거가 모두 이 시점까지 제공되었습니다",
    "Some cited evidence was unavailable at this time": "이 시점에는 일부 인용 근거를 사용할 수 없었습니다",
    "Some evidence was unavailable at the selected time. Open the cited posts before relying on this answer.":
      "선택한 시점에 일부 근거를 사용할 수 없습니다. 이 답변을 사용하기 전에 인용된 글을 여세요.",
    ...
    "Ask a workspace administrator to enable public verification, then retry.": "워크스페이스 관리자에게 공개 자료 검증 사용 설정을 요청한 후 다시 시도하세요.",
    "Ask about a specific claim or narrow the time range, then retry.": "구체적인 주장을 질문하거나 기간을 좁힌 후 다시 시도하세요.",
    ...
    "Open the cited posts and compare their retained source text before relying on this answer.": "이 답변을 사용하기 전에 인용된 글을 열어 보존된 원문을 비교하세요.",
    "Compare these cutoff-grounded citations with live evidence next.": "다음으로 컷오프 시점 인용과 현재 근거를 비교하세요.",
    Ask: "질의",
    "Asking...": "질의 중...",
    Answer: "답변",
    "Cited posts": "인용된 글",
    "Reports and evidence alerts": "리포트와 근거 알림",
    ...
    "Related role": "관련 역할",
    "Related key person": "관련 핵심 담당자",
    "Related record": "관련 기록",
    "Time axis": "시간 축",
    "No authorized source posts matched this question.": "이 질문과 일치하는 권한 있는 원문이 없습니다.",
    "Ask about a specific project, person, organization, or time range, then retry.": "특정 프로젝트, 인물, 조직 또는 기간을 지정해 다시 질문하세요.",
    ...
    Tickets: "티켓",
	    Summary: "요약",
	    "Last saved summary shown. Retry summary refresh.": "마지막 저장 요약을 표시합니다. 요약 새로고침을 다시 시도하세요.",
    ...
    "Additional context review was unavailable. Open both source posts and compare the listed signals before relying on this connection.":
      "추가 맥락 검토를 사용할 수 없습니다. 이 연결을 사용하기 전에 두 원본 글을 열고 표시된 근거를 비교하세요.",
    "Open connection evidence: {from} to {to}": "연결 근거 열기: {from} → {to}",
    "{from} follows {to}, connection score {score}":
      "{from}이(가) {to}을(를) 따름, 연결 점수 {score}",
    "Recorded signal": "기록된 근거",
    Signal: "신호",
    Score: "점수",
    Weight: "가중치",
    Contribution: "기여",
  ...
  zh: {
    ...
    "Derived from post evidence": "从文章证据中确认",
    "Recorded extraction": "已记录的提取",
    "Project evidence from this post": "此帖子中的项目证据",
    "Additional classified records": "新增分类记录",
    ...
    "The original text of this post was not imported, so its summary and related details are unavailable.": "这篇文章的原文尚未导入，因此无法提供摘要和相关详情。",
    "Open the post directly or ask the source owner to re-import it with its body.": "请直接打开文章，或请数据负责人连同正文重新导入。",
    ...
    "Search related evidence": "搜索相关证据",
    Search: "搜索",
    "Search includes post text and related evidence.": "同时搜索文章正文和相关证据。",
    ...
    "Project history could not be loaded.": "无法加载项目历史。",
    "Retry the same project and evidence cutoff.": "使用相同项目和证据截止时间重试。",
    "This case has no explicit project key.": "此案例没有明确的项目键。",
    "Open the source evidence and connect an explicit project code or accepted semantic project key.": "打开来源证据，并关联明确的项目代码或已接受的语义项目键。",
    ...
    "Open product evidence post": "打开产品证据帖子",
    "Open relationship evidence post": "打开关系证据帖子",
    "Ask a catalog manager to register this cited product, then run product analysis again.": "请让目录管理员登记此证据中的产品，然后重新运行产品分析。",
    "Ask a catalog manager to distinguish the matching products, then run product analysis again.": "请让目录管理员区分匹配的产品，然后重新运行产品分析。",
    "Retry product analysis after catalog access is restored.": "产品目录恢复访问后，请重试产品分析。",
    "No product was identified in this post.": "此帖子中未识别出产品。",
    "Product evidence analysis is in progress.": "正在分析产品证据。",
    "Product evidence is not available yet.": "产品证据尚不可用。",
    "Historical product evidence is not available.": "历史时点的产品证据不可用。",
    "Refresh this post after product analysis is available.": "产品分析可用后，请重新查看此帖子。",
    "Run product analysis again, then review source evidence and linked products.": "请重新运行产品分析，然后查看来源证据和关联产品。",
    "Review this post's product evidence separately from the historical body.": "请分别查看当前帖子的产品证据和历史正文。",
    "Open the linked products and source evidence.": "请打开关联产品和来源证据。",
    "Open the source text and confirm that no product was mentioned.": "请打开来源正文并确认其中未提及产品。",
    "Review product evidence again after analysis finishes.": "分析完成后，请再次查看产品证据。",
    "Ask an administrator to enable product analysis, then review this post again.": "请管理员启用产品分析，然后再次查看此帖子。",
    "Run product analysis again, then review the result.": "请重新运行产品分析，然后查看结果。",
    "Before linking a customer, compare the source identifier with the related posts and organization evidence.":
      "关联客户前，请将源标识符与相关帖子和组织证据进行比较。",
    "Before connecting a customer, compare each source identifier with the related posts and organization evidence.": "连接客户前，请将每个源标识符与相关文章和组织证据进行比较。",
    ...
    "Evidence at selected time": "所选时间点的证据",
    "All cited evidence was available by this time": "所有引用证据在此时间点前均可用",
    "Some cited evidence was unavailable at this time": "此时间点有部分引用证据不可用",
    "Some evidence was unavailable at the selected time. Open the cited posts before relying on this answer.":
      "所选时间点的部分证据不可用。依赖此答案前，请打开引用文章。",
    ...
    "Ask a workspace administrator to enable public verification, then retry.": "请工作区管理员启用公开资料核验，然后重试。",
    "Ask about a specific claim or narrow the time range, then retry.": "请询问具体声明或缩小时间范围，然后重试。",
    ...
    "Open the cited posts and compare their retained source text before relying on this answer.": "依赖此答案前，请打开引用文章并比较其中保留的原文。",
    ...
    "Related role": "相关角色",
    "Related key person": "相关关键人员",
    "Related record": "相关记录",
    "Time axis": "时间轴",
    "No authorized source posts matched this question.": "没有与此问题匹配的已授权来源文章。",
    "Ask about a specific project, person, organization, or time range, then retry.": "请指定项目、人员、组织或时间范围，然后重试。",
    ...
    Tickets: "工单",
	    Summary: "摘要",
	    "Last saved summary shown. Retry summary refresh.": "正在显示上次保存的摘要。请重试摘要刷新。",
    ...
    "Additional context review was unavailable. Open both source posts and compare the listed signals before relying on this connection.": "无法进行额外的上下文复核。依赖此连接前，请打开两篇源文章并比较所列证据。",
    "Open connection evidence: {from} to {to}": "打开连接证据：{from} 至 {to}",
    "{from} follows {to}, connection score {score}": "{from} 接续 {to}，连接分数 {score}",
    "Recorded signal": "已记录的依据",
    Signal: "信号",
    Score: "分数",
    Weight: "权重",
    Contribution: "贡献",
    ...
    "Leftover map after IRT main effects. Axis ticks name persisted leftover-map coordinates. Pair segments name leftover-map distance d. Click a post marker to open that post. The plot does not invent a leftover score.":
      "IRT 主效应后的残差图。轴刻度标出已保存的残差图坐标。配对线段标出残差图距离 d。点击帖子标记打开该帖子。此图不会虚构残差分数。",
    "Open leftover-map post {title} at ξ {person}":
  ...
  ja: {
    ...
    "Derived from post evidence": "投稿の根拠から確認",
    "Recorded extraction": "記録された抽出",
    "Project evidence from this post": "この投稿で確認したプロジェクト根拠",
    "Additional classified records": "追加で分類された記録",
    ...
    "The original text of this post was not imported, so its summary and related details are unavailable.": "この投稿の本文が取り込まれていないため、要約と関連する詳細を利用できません。",
    "Open the post directly or ask the source owner to re-import it with its body.": "投稿を直接開くか、本文ごとの再取り込みを担当者に依頼してください。",
    ...
    "Search related evidence": "関連する根拠を検索",
    Search: "検索",
    "Search includes post text and related evidence.": "投稿本文と関連する根拠を検索します。",
    ...
    "Project history could not be loaded.": "プロジェクト履歴を読み込めませんでした。",
    "Retry the same project and evidence cutoff.": "同じプロジェクトと根拠の基準時点で再試行してください。",
    "This case has no explicit project key.": "このケースには明示的なプロジェクトキーがありません。",
    "Open the source evidence and connect an explicit project code or accepted semantic project key.": "元の根拠を開き、明示的なプロジェクトコードまたは承認済みの意味プロジェクトキーを接続してください。",
    ...
    "Open product evidence post": "製品根拠の投稿を開く",
    "Open relationship evidence post": "関係根拠の投稿を開く",
    "Ask a catalog manager to register this cited product, then run product analysis again.": "カタログ担当者に根拠となる製品の登録を依頼し、製品分析を再実行してください。",
    "Ask a catalog manager to distinguish the matching products, then run product analysis again.": "カタログ担当者に一致した製品の区別を依頼し、製品分析を再実行してください。",
    "Retry product analysis after catalog access is restored.": "製品カタログへのアクセスが復旧した後、製品分析を再試行してください。",
    "No product was identified in this post.": "この投稿では製品が確認されませんでした。",
    "Product evidence analysis is in progress.": "製品根拠を分析しています。",
    "Product evidence is not available yet.": "製品根拠はまだ利用できません。",
    "Historical product evidence is not available.": "当時時点の製品根拠は利用できません。",
    "Refresh this post after product analysis is available.": "製品分析が利用可能になった後、この投稿を再確認してください。",
    "Run product analysis again, then review source evidence and linked products.": "製品分析を再実行し、原文の根拠と関連製品を確認してください。",
    "Review this post's product evidence separately from the historical body.": "現在の投稿の製品根拠と当時の本文を分けて確認してください。",
    "Open the linked products and source evidence.": "関連製品と原文の根拠を開いて確認してください。",
    "Open the source text and confirm that no product was mentioned.": "原文を開き、製品への言及がないことを確認してください。",
    "Review product evidence again after analysis finishes.": "分析完了後、製品根拠を再確認してください。",
    "Ask an administrator to enable product analysis, then review this post again.": "管理者に製品分析の有効化を依頼し、この投稿を再確認してください。",
    "Run product analysis again, then review the result.": "製品分析を再実行し、結果を確認してください。",
    "Before linking a customer, compare the source identifier with the related posts and organization evidence.":
      "顧客を紐付ける前に、元の識別子を関連投稿と組織の根拠と照合してください。",
    "Before connecting a customer, compare each source identifier with the related posts and organization evidence.": "顧客を紐付ける前に、各ソース識別子を関連投稿と組織の根拠と比較してください。",
    ...
    "Evidence at selected time": "選択した時点の根拠",
    "All cited evidence was available by this time": "引用された根拠はすべてこの時点までに利用可能でした",
    "Some cited evidence was unavailable at this time": "この時点では一部の引用根拠を利用できませんでした",
    "Some evidence was unavailable at the selected time. Open the cited posts before relying on this answer.":
      "選択した時点では一部の証拠を利用できません。この回答を利用する前に引用投稿を開いてください。",
    ...
    "Ask a workspace administrator to enable public verification, then retry.": "ワークスペース管理者に公開資料の検証を有効にするよう依頼してから、再試行してください。",
    "Ask about a specific claim or narrow the time range, then retry.": "具体的な主張について質問するか期間を絞ってから、再試行してください。",
    ...
    "Open the cited posts and compare their retained source text before relying on this answer.": "この回答を利用する前に、引用投稿を開いて保持された原文を比較してください。",
    ...
    "Related role": "関連する役割",
    "Related key person": "関連するキーパーソン",
    "Related record": "関連記録",
    "Time axis": "時間軸",
    "No authorized source posts matched this question.": "この質問に一致する許可済みの原文投稿はありません。",
    "Ask about a specific project, person, organization, or time range, then retry.": "特定のプロジェクト、人物、組織、または期間を指定して、もう一度質問してください。",
    ...
    Tickets: "チケット",
    Summary: "概要",
    "Last saved summary shown. Retry summary refresh.": "保存済みの最新の要約を表示しています。要約の更新を再試行してください。",
    ...
    "Additional context review was unavailable. Open both source posts and compare the listed signals before relying on this connection.":
      "追加の文脈確認を利用できません。この接続を利用する前に、両方の元投稿を開いて表示された根拠を比較してください。",
    "Open connection evidence: {from} to {to}": "接続の根拠を開く: {from} → {to}",
    "{from} follows {to}, connection score {score}":
      "{from}は{to}に続く、接続スコア {score}",
    "Recorded signal": "記録された根拠",
    Signal: "信号",
    Score: "スコア",
    Weight: "重み",
    Contribution: "寄与",
  ...
  vi: {
    ...
    "Derived from post evidence": "Xác nhận từ bằng chứng bài viết",
    "Recorded extraction": "Bản trích xuất đã ghi nhận",
    "Project evidence from this post": "Bằng chứng dự án từ bài viết này",
    "Additional classified records": "Bản ghi được phân loại thêm",
    ...
    "The original text of this post was not imported, so its summary and related details are unavailable.": "Bản gốc của bài viết chưa được nhập nên không thể xem bản tóm tắt và chi tiết liên quan.",
    "Open the post directly or ask the source owner to re-import it with its body.": "Hãy mở trực tiếp bài viết hoặc yêu cầu người phụ trách nhập lại kèm bản gốc.",
    ...
    "Search related evidence": "Tìm bằng chứng liên quan",
    Search: "Tìm",
    "Search includes post text and related evidence.": "Tìm trong nội dung bài viết và bằng chứng liên quan.",
    ...
    "Project history could not be loaded.": "Không thể tải lịch sử dự án.",
    "Retry the same project and evidence cutoff.": "Thử lại với cùng dự án và thời điểm giới hạn bằng chứng.",
    "This case has no explicit project key.": "Trường hợp này chưa có khóa dự án rõ ràng.",
    "Open the source evidence and connect an explicit project code or accepted semantic project key.": "Mở bằng chứng nguồn và liên kết mã dự án rõ ràng hoặc khóa dự án ngữ nghĩa đã được chấp nhận.",
    ...
    "Open product evidence post": "Mở bài viết bằng chứng sản phẩm",
    "Open relationship evidence post": "Mở bài viết bằng chứng quan hệ",
    "Ask a catalog manager to register this cited product, then run product analysis again.": "Hãy yêu cầu người quản lý danh mục đăng ký sản phẩm được trích dẫn này, rồi chạy lại phân tích sản phẩm.",
    "Ask a catalog manager to distinguish the matching products, then run product analysis again.": "Hãy yêu cầu người quản lý danh mục phân biệt các sản phẩm trùng khớp, rồi chạy lại phân tích sản phẩm.",
    "Retry product analysis after catalog access is restored.": "Hãy thử lại phân tích sản phẩm sau khi quyền truy cập danh mục được khôi phục.",
    "No product was identified in this post.": "Không xác định được sản phẩm trong bài viết này.",
    "Product evidence analysis is in progress.": "Đang phân tích bằng chứng sản phẩm.",
    "Product evidence is not available yet.": "Bằng chứng sản phẩm chưa khả dụng.",
    "Historical product evidence is not available.": "Bằng chứng sản phẩm tại thời điểm lịch sử chưa khả dụng.",
    "Refresh this post after product analysis is available.": "Hãy kiểm tra lại bài viết này sau khi phân tích sản phẩm khả dụng.",
    "Run product analysis again, then review source evidence and linked products.": "Hãy chạy lại phân tích sản phẩm, sau đó xem bằng chứng nguồn và các sản phẩm được liên kết.",
    "Review this post's product evidence separately from the historical body.": "Hãy xem riêng bằng chứng sản phẩm của bài viết hiện tại và nội dung lịch sử.",
    "Open the linked products and source evidence.": "Hãy mở các sản phẩm được liên kết và bằng chứng nguồn.",
    "Open the source text and confirm that no product was mentioned.": "Hãy mở văn bản nguồn và xác nhận rằng không có sản phẩm nào được đề cập.",
    "Review product evidence again after analysis finishes.": "Sau khi phân tích hoàn tất, hãy xem lại bằng chứng sản phẩm.",
    "Ask an administrator to enable product analysis, then review this post again.": "Hãy yêu cầu quản trị viên bật phân tích sản phẩm, sau đó xem lại bài viết này.",
    "Run product analysis again, then review the result.": "Hãy chạy lại phân tích sản phẩm, sau đó xem kết quả.",
    "Before linking a customer, compare the source identifier with the related posts and organization evidence.":
      "Trước khi liên kết khách hàng, hãy đối chiếu mã định danh nguồn với các bài viết liên quan và bằng chứng tổ chức.",
    "Before connecting a customer, compare each source identifier with the related posts and organization evidence.": "Trước khi liên kết khách hàng, hãy so sánh từng mã định danh nguồn với các bài viết liên quan và bằng chứng tổ chức.",
    ...
    "Evidence at selected time": "Bằng chứng tại thời điểm đã chọn",
    "All cited evidence was available by this time": "Tất cả bằng chứng được trích dẫn đã có sẵn trước thời điểm này",
    "Some cited evidence was unavailable at this time": "Một số bằng chứng được trích dẫn không có sẵn tại thời điểm này",
    "Some evidence was unavailable at the selected time. Open the cited posts before relying on this answer.":
      "Một số bằng chứng không khả dụng tại thời điểm đã chọn. Hãy mở các bài viết được trích dẫn trước khi dựa vào câu trả lời này.",
    ...
    "Ask about a specific claim or narrow the time range, then retry.": "Hãy hỏi về một tuyên bố cụ thể hoặc thu hẹp khoảng thời gian rồi thử lại.",
    ...
    "Open the cited posts and compare their retained source text before relying on this answer.": "Hãy mở các bài viết được trích dẫn và so sánh nguyên văn được lưu giữ trước khi dựa vào câu trả lời này.",
    ...
    "Related role": "Vai trò liên quan",
    "Related key person": "Người chủ chốt liên quan",
    "Related record": "Bản ghi liên quan",
    "Time axis": "Trục thời gian",
    "No authorized source posts matched this question.": "Không có bài viết nguồn được cấp quyền nào phù hợp với câu hỏi này.",
    "Ask about a specific project, person, organization, or time range, then retry.": "Hãy hỏi về một dự án, người, tổ chức hoặc khoảng thời gian cụ thể rồi thử lại.",
    ...
    Summary: "Tóm tắt",
    "Last saved summary shown. Retry summary refresh.": "Đang hiển thị bản tóm tắt đã lưu gần nhất. Hãy thử làm mới bản tóm tắt.",
    ...
    "Additional context review was unavailable. Open both source posts and compare the listed signals before relying on this connection.":
      "Không thể thực hiện bước xem xét ngữ cảnh bổ sung. Hãy mở cả hai bài viết nguồn và so sánh các bằng chứng được liệt kê trước khi dựa vào kết nối này.",
    "Open connection evidence: {from} to {to}": "Mở bằng chứng liên kết: {from} đến {to}",
    "{from} follows {to}, connection score {score}":
      "{from} tiếp nối {to}, điểm liên kết {score}",
    "Recorded signal": "Bằng chứng đã ghi",
    Signal: "Tín hiệu",
    Score: "Điểm",
    Weight: "Trọng số",
    ...
    "Context review": "Xem xét ngữ cảnh",
