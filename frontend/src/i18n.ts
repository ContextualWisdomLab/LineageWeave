...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    "Leftover map comparison unexplained leftover share": "잔여 지도 비교 미설명 잔여 비율",
  ...
  zh: {
    ...
    "Leftover map comparison unexplained leftover share": "残差地图比较未解释残差占比",
  ...
  ja: {
    ...
    "Leftover map comparison unexplained leftover share": "残差マップの比較未説明残差比率",
  ...
  vi: {
    ...
    "Leftover map comparison unexplained leftover share": "Tỷ phần phần dư chưa được giải thích khi so sánh bản đồ phần dư",
