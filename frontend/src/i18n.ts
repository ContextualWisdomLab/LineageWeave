...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    Revoke: "폐기",
    Copied: "복사됨",
    "Copy this key now; it will not be shown again.": "지금 이 키를 복사하세요. 다시 표시되지 않습니다.",
    "No API keys.": "API 키가 없습니다.",
    Active: "활성",
    Revoked: "폐기됨",
    "MCP read": "MCP 읽기",
    "Loading API keys...": "API 키를 불러오는 중...",
    "API key could not be loaded.": "API 키를 불러오지 못했습니다.",
    "API key could not be created.": "API 키를 만들지 못했습니다.",
    "API key could not be revoked.": "API 키를 폐기하지 못했습니다.",
    Calendar: "캘린더",
  ...
  zh: {
    ...
    Revoke: "撤销",
    Copied: "已复制",
    "Copy this key now; it will not be shown again.": "请立即复制此密钥，之后将不再显示。",
    "No API keys.": "没有 API 密钥。",
    Active: "有效",
    Revoked: "已撤销",
    "MCP read": "MCP 读取",
    "Loading API keys...": "正在加载 API 密钥...",
    "API key could not be loaded.": "无法加载 API 密钥。",
    "API key could not be created.": "无法创建 API 密钥。",
    "API key could not be revoked.": "无法撤销 API 密钥。",
    Calendar: "日历",
  ...
  ja: {
    ...
    Revoke: "失効",
    Copied: "コピーしました",
    "Copy this key now; it will not be shown again.": "今すぐこのキーをコピーしてください。再表示されません。",
    "No API keys.": "APIキーはありません。",
    Active: "有効",
    Revoked: "失効済み",
    "MCP read": "MCP読み取り",
    "Loading API keys...": "APIキーを読み込み中...",
    "API key could not be loaded.": "APIキーを読み込めませんでした。",
    "API key could not be created.": "APIキーを作成できませんでした。",
    "API key could not be revoked.": "APIキーを失効できませんでした。",
    Calendar: "カレンダー",
  ...
  vi: {
    ...
    Revoke: "Thu hồi",
    Copied: "Đã sao chép",
    "Copy this key now; it will not be shown again.": "Hãy sao chép khóa này ngay; khóa sẽ không hiển thị lại.",
    "No API keys.": "Chưa có khóa API.",
    Active: "Đang hoạt động",
    Revoked: "Đã thu hồi",
    "MCP read": "Đọc MCP",
    "Loading API keys...": "Đang tải khóa API...",
    "API key could not be loaded.": "Không thể tải khóa API.",
    "API key could not be created.": "Không thể tạo khóa API.",
    "API key could not be revoked.": "Không thể thu hồi khóa API.",
    Calendar: "Lịch",
