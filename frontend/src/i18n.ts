...
const TRANSLATIONS: Partial<Record<Locale, Record<string, string>>> = {
  ko: {
    ...
    "leftover map comparison graphic residual {label}": "잔여 지도 비교 그림 잔여 {label}",
  ...
  zh: {
    ...
    "leftover map comparison graphic residual {label}": "残差地图比较图形残差 {label}",
  ...
  ja: {
    ...
    "leftover map comparison graphic residual {label}": "残差マップの比較図残差 {label}",
  ...
  vi: {
    ...
    "leftover map comparison graphic residual {label}": "phần dư đồ họa so sánh {label}",
