...
const EN: Record<ProjectHistoryMessageKey, string> = {
  ...
  recordedDocumentTime: "Dates use the document time recorded by the source.",
...
const MESSAGES: Record<Locale, Record<ProjectHistoryMessageKey, string>> = {
  ...
  ko: {
    ...
    recordedDocumentTime: "날짜는 원천에 기록된 문서 시각을 사용합니다.",
  ...
  zh: {
    ...
    recordedDocumentTime: "日期采用来源记录的文档时间。",
  ...
  ja: {
    ...
    recordedDocumentTime: "日付には原資料に記録された文書時刻を使用します。",
  ...
  vi: {
    ...
    recordedDocumentTime: "Ngày dùng thời gian tài liệu do nguồn ghi nhận.",
