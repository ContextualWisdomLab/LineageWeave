...
def seed(
    ...
    try:
        with conn.cursor() as cur:
            ...
            cur.execute((migrations / "0186_report_leftover_map_reconstruction.sql").read_text())
...
def _persist_seed_period_report(
    ...
    for pair in report.leftover_pairs:
        cur.execute(
            ...
            "observed_response, expected_response, leftover_map_rank, leftover_map_reconstruction"
