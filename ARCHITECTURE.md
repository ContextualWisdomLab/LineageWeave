...
residual SVD leftover pairs (Jeon et al., 2021; ADR 0048 / 0185) persist to
`report_leftover_pair` with leftover-map cross share `x = 2 R̂_c U_c / R̃²`
of centered leftover named on the pair row. Results persist to
