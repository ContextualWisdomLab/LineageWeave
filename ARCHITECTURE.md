...
residual SVD leftover pairs (Jeon et al., 2021; ADR 0048 / 0178) persist to
`report_leftover_pair` with leftover residual named on the pair row. Results persist to
...
closest/farthest pairs (signed leftover residual `R` next to leftover-map
distance `d`) above the member list, and the
