...
residual SVD leftover pairs (Jeon et al., 2021; ADR 0048 / 0182) persist to
`report_leftover_pair` with unexplained leftover `U = R − R̂` named on the pair row. Results persist to
