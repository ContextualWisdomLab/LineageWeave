...
ADR 0048 / 0119 / 0162 / 0163 / 0164 / 0184) persist to `report_leftover_pair`
with signed residual `R`, observed `Y`, expected `E[Y|θ, item]`, full
leftover-map rank, and explained leftover share `e = R̂_c² / R̃²` of
centered leftover. Results persist to
