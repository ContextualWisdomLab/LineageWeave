...
| `frontend/src/components/OccupationRatingProfile.tsx` | Selects an imported source, filters its stored occupation titles or retained codes without ranking, and reads exact Dashboard evidence while preserving absence, uncertainty, and warning semantics (ADR 0259–0262) |
