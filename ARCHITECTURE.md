...
residual SVD leftover pairs (Jeon et al., 2021; ADR 0048 / 0179) persist to
`report_leftover_pair` with leftover-map inner product named on the pair row. Results persist to
...
closest/farthest pairs (leftover-map inner product `ξ·ζ` next to
