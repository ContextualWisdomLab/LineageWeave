...
ADR 0017 / 0048 / 0119 / 0162 / 0163 / 0164 / 0186) persist to
`report_leftover_pair` with signed residual `R`, observed `Y`, expected
`E[Y|θ, item]`, full leftover-map rank, and two-axis leftover-map
reconstruction `R̂`. Leftover-map axis share (Gabriel inertia of
