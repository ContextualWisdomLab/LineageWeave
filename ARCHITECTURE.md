...
ADR 0048 / 0119 / 0162 / 0163 / 0164 / 0185) persist to `report_leftover_pair`
with signed residual `R`, observed `Y`, expected `E[Y|θ, item]`, full
leftover-map rank, and leftover-map cross share `x = 2 R̂_c U_c / R̃²`
of centered leftover. Results persist to
