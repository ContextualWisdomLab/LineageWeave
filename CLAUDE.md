...
distance `d`, and explained leftover share `R̂²/R̃²`. Leftover-map axis
share badges name Gabriel inertia of axes 1 and 2; open a leftover
pair to read the post–criterion cell.
