...
leftover structure, unexplained leftover `U` next to leftover-map
distance `d`, and unexplained leftover share `U²/R̃²`. Leftover-map
axis share badges name Gabriel inertia of axes 1 and 2; open a
leftover pair to read the post–criterion cell. The shares do not
