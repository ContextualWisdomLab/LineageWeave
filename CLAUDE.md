...
`corporate_entity` by `entity_name`. Persist and historical backfill
leave a role unbound when two same-named catalog rows or mentions
already exist on the post.
