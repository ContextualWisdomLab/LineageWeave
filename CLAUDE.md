...
pending TEPP row does not claim a calibrated measurement and does not
say reconstruction has not started. The list-button accessible name
includes that next-action sentence.
