...
def apply_red() -> None:
    """Add regressions that fail on missing replay and reversed/untranslated edges."""
...
describe("LineageDag evidence disclosure", () => {''',
    ...
    _append_once(
        "frontend/src/LineageDag.test.tsx",
        "describes the child as following the parent",
        '''

describe("LineageDag edge direction and locale", () => {
  it("describes the child as following the parent", () => {
...
/** Format one stored parent-to-child edge without allowing label interpolation. */
export function lineageEvidenceEdgeDescription(
  child: string,
  parent: string,
  score: string,
