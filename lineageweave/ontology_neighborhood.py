...
PROPERTY_SUPPORTS_OCCUPATIONAL_CONSTRUCT = "supportsOccupationalConstruct"
...
_KG_PROPERTY_BY_EDGE = {
    ...
    EDGE_SUPPORTS_OCCUPATIONAL_CONSTRUCT: PROPERTY_SUPPORTS_OCCUPATIONAL_CONSTRUCT,
}
_PROPERTY_IRI = {
    ...
    PROPERTY_SUPPORTS_OCCUPATIONAL_CONSTRUCT: str(LW.supportsOccupationalConstruct),
...
NODE_SHAPE = {
    ...
    NODE_OCCUPATIONAL_CONSTRUCT: "rounded-rectangle",
}
    ...
    annotations = ontology_annotations(
        {
            ...
            PROPERTY_SUPPORTS_OCCUPATIONAL_CONSTRUCT: EDGE_SUPPORTS_OCCUPATIONAL_CONSTRUCT,
        }[property_code]
    )
