...
Leftover post–criterion pairs (ADR 0017 / 0048) come from the residual
...
and 2 (ADR 0148). Complete-case coverage (ADR 0169) names how many
...
def leftover_pairs_for_fit(
    ...
    pairs, _axes = leftover_map_for_fit(post_ids, item_codes, matrix, model, theta, fit)
    return pairs
